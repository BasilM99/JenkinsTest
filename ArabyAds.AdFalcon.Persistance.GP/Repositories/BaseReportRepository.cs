...
namespace ArabyAds.AdFalcon.Persistence.Reports.RepositoriesGP
{
    public class BaseReportGPRepository : RepositoryBase<ChartDto, int> 
    {
        ...
        public BaseReportGPRepository(RepositoryImplBase<ChartDto, int> repository, ArabyAds.Framework.ConfigurationSetting.IConfigurationManager configurationManager)
            : base(repository)
        {
