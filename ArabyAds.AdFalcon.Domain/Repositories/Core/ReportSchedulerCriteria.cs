...
namespace ArabyAds.AdFalcon.Domain.Repositories.Core
{
    ...
    public class ReportSchedulerCriteria : CriteriaBase<Model.Core.ReportScheduler>
    {
        ...
        public void CopyFromCommonToDomain(ArabyAds.AdFalcon.Domain.Common.Repositories.Core.ReportSchedulerCriteria  Commoncr)
        {
    ...
    public class ReportJsonCriteria : CriteriaBase<Model.Core.ReportCriteria>
    {
        ...
        public void CopyFromCommonToDomain(ArabyAds.AdFalcon.Domain.Common.Repositories.Core.ReportJsonCriteria Commoncr)
        {
            DateFrom = Commoncr.DateFrom;
            DateTo = Commoncr.DateTo;
            Page = Commoncr.Page;
