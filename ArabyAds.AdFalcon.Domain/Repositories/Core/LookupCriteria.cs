...
namespace ArabyAds.AdFalcon.Domain.Repositories.Core
{
    public class LookupCriteriaBase : CriteriaBase<ManagedLookupBase>
    {
        ...
        public void CopyFromCommonToDomain(ArabyAds.AdFalcon.Domain.Common.Repositories.Core.LookupCriteriaBase Commoncr)
        {
    ...
    public class LookupGetCriteria : LookupCriteriaBase
    {
        ...
        public void CopyFromCommonToDomain(ArabyAds.AdFalcon.Domain.Common.Repositories.Core.LookupGetCriteria Commoncr)
        {
            Id = Commoncr.Id;
            LookType = Commoncr.LookType;
        }
    ...
    public class LookupCriteria : LookupGetCriteria
    {
        ...
        public void CopyFromCommonToDomain(ArabyAds.AdFalcon.Domain.Common.Repositories.Core.LookupCriteria Commoncr)
        {
            Id = Commoncr.Id;
            LookType = Commoncr.LookType;
    ...
    public class DeviceLookupCriteria : LookupCriteria
    {
        ...
        public void CopyFromCommonToDomain(ArabyAds.AdFalcon.Domain.Common.Repositories.Core.DeviceLookupCriteria Commoncr)
        {
            Id = Commoncr.Id;
            LookType = Commoncr.LookType;
