...
namespace ArabyAds.AdFalcon.Domain.Repositories.Campaign
{
    public class CampaignCriteria : CriteriaBase<Model.Campaign.Campaign>
    {
        ...
        public void CopyFromCommonToDomain(ArabyAds.AdFalcon.Domain.Common.Repositories.Campaign.CampaignCriteria Commoncr)
        {
    ...
    public class AllCampaignCriteria : CriteriaBase<Model.Campaign.Campaign>
    {
        ...
        public void CopyFromCommonToDomain(ArabyAds.AdFalcon.Domain.Common.Repositories.Campaign.AllCampaignCriteria Commoncr)
        {
            AppSiteId = Commoncr.AppSiteId;
