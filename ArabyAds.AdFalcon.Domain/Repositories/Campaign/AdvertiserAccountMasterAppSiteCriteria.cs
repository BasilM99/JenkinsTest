...
namespace ArabyAds.AdFalcon.Domain.Repositories.Campaign
{
    public class AdvertiserAccountMasterAppSiteCriteria : CriteriaBase<AdvertiserAccountMasterAppSite>
    {
        ...
        public void CopyFromCommonToDomain(ArabyAds.AdFalcon.Domain.Common.Repositories.Campaign.AdvertiserAccountMasterAppSiteCriteria Commoncr)
        {
               ...
               && ((!GlobalScope.HasValue) || (c.GlobalScope == GlobalScope))
                 ...
                 if (this.showAccountAndAdvertiser)
                {
                    filter =
                       (c => (c.IsDeleted == false || c.IsDeleted == showArchived)
                       && ((!userId.HasValue) /*|| (c.User.ID == userId)*/)
                              && (((!AccountId.HasValue) || (c.Account.ID == AccountId  && c.Link == null )   )    || ((!AdvAccountId.HasValue) || (c.Link.ID == AdvAccountId))     )
                   && ((!GlobalScope.HasValue) || (c.GlobalScope == GlobalScope))
            ...
            else
            {
                filter =
                    (c => (c.IsDeleted == false || c.IsDeleted == showArchived)
                     ...
                     && ((c.GlobalScope == true) || (c.Link.ID == AdvAccountId) || ((!AccountId.HasValue) || (c.Account.ID == AccountId && c.Link == null)))
                      && ((Status == MasterAppSiteStatus.None) || (c.Status == Status))
                               && ((Type == MasterAppSiteType.None) || (c.Type == Type))
                    && (string.IsNullOrEmpty(Name) || c.Name.ToLower().Contains(Name))
                    );
    ...
    public class AudienceSegmentCriteria : CriteriaBase<AudienceSegment>
    {
        ...
        public void CopyFromCommonToDomain(ArabyAds.AdFalcon.Domain.Common.Repositories.Campaign.AudienceSegmentCriteria Commoncr)
        {
    ...
    public class AdvertiserAccountMasterAppSiteItemCriteria : CriteriaBase<AdvertiserAccountMasterAppSiteItem>
    {
        ...
        public void CopyFromCommonToDomain(ArabyAds.AdFalcon.Domain.Common.Repositories.Campaign.AdvertiserAccountMasterAppSiteItemCriteria Commoncr)
        {
    ...
    public class PixelCriteria : CriteriaBase<Pixel>
    {
        ...
        public void CopyFromCommonToDomain(ArabyAds.AdFalcon.Domain.Common.Repositories.Campaign.PixelCriteria Commoncr)
        {
            AdvAccountId = Commoncr.AdvAccountId;
            Value = Commoncr.Value;
            Name = Commoncr.Name;
