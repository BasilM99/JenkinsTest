        ...
        protected virtual void UnZipp(byte[] Content, string destDirPath, out string indexPath)
        {
            ...
            try
            {
                ...
                while ((entry = zipIn.GetNextEntry()) != null)
                {
                    ...
                    if (!Framework.Utilities.CDNHelper.DirectoryExists(EncodedPath))
                    {
                        Framework.Utilities.CDNHelper.CreateDirectory(EncodedPath);
                    }
                    ...
                    if (!entry.IsDirectory)
                    {
                        ...
                        Framework.Utilities.CDNHelper.Upload(EncodedPath + HttpUtility.UrlEncode(entry.Name), bytesContent);
                    }
