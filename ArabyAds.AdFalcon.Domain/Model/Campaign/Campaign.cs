...
namespace ArabyAds.AdFalcon.Domain.Model.Campaign
{
    ...
    public class Campaign : AdBase<Campaign, AdCampaignStatus>
    {
        ...
        public virtual IList<CampaignBidModifier> CampaignBidModifiers { get; set; }
        ...
        public override Campaign Clone()
        {
            ...
            cloneObj.ChangeCampaignBidModifier(this.CampaignBidModifiers);
        ...
        {
            return this.AdGroups.Any(item => item.IsDeleted == false);
        }
        ...
        public virtual IList<CampaignBidModifier> GetCampaignBidModifier(bool? reurtnIsDeleted = false)
        {
            if (reurtnIsDeleted.HasValue && this.CampaignBidModifiers!=null)
            {
                return this.CampaignBidModifiers.Where(x => x.IsDeleted == reurtnIsDeleted).ToList();
            }
            else if(this.CampaignBidModifiers!=null)
            {
                return this.CampaignBidModifiers.Where(x => !x.IsDeleted).ToList();
            }
            return new List<CampaignBidModifier>();
        }


        public virtual void AddCampaignBidModifiers(CampaignBidModifier campaignBidModifier)
        {
            CampaignBidModifier existCampaignModifier = GetCampaignBidModifier().Where(x => x.ID == campaignBidModifier.ID ).FirstOrDefault();
            if (existCampaignModifier != null && existCampaignModifier.ID != 0)// Incase add already exist CampaignAssignedAppsite for the same campign and Appsite.Id  
            {// update the existing item 
                existCampaignModifier.IsDeleted = false;
                existCampaignModifier.Multiplier = campaignBidModifier.Multiplier;
                existCampaignModifier.DimentionType = campaignBidModifier.DimentionType;
                existCampaignModifier.DimensionValue = campaignBidModifier.DimensionValue;
                //existCampaignAssignedAppsite.Include = campaignAssignedAppsites.Include;
                return;
            }

            if (campaignBidModifier.Campaign == null)
            {
                campaignBidModifier.Campaign = this;
                campaignBidModifier.IsDeleted = false;
            }
            if (this.CampaignBidModifiers == null)
            {
                this.CampaignBidModifiers = new List<CampaignBidModifier>();
            }
            this.CampaignBidModifiers.Add(campaignBidModifier);
        }
        ...
        public virtual void DeleteBidModifier(int id)
        {
            if (this.CampaignBidModifiers!=null)
            {
                CampaignBidModifier modfier = this.CampaignBidModifiers.Where(x => x.ID == id).FirstOrDefault();
                if (modfier != null)
                {
                    modfier.IsDeleted = true;
                }
            }
        }
        ...
        public virtual IList<AppSiteAdQueue> GetAppSiteAdQueue(AdGroup group, AdCreative ad)
        {
            if (group != null && ad!=null)
            {
               return ad.AppSiteAdQueues;
            }
            return new List<AppSiteAdQueue>();
        }
        public virtual bool  ExistAppSiteAdQueue(AdGroup group, AdCreative ad , AppSite.AppSite appSite)
        {
            if (group != null && ad != null)
            {
                return ad.ExistAppSiteAdQueue(appSite);
            }
            return false;
        }
        ...
        public virtual void ChangeCampaignBidModifier(IList<CampaignBidModifier> settings)
        {
            if (this.CampaignBidModifiers == null)
            {
                CampaignBidModifiers = new List<CampaignBidModifier>();
            }
            if (settings != null)

            {
                foreach (var setting in settings)
                {
                    var ob = setting.Clone();
                    ob.Campaign = this;
                    this.CampaignBidModifiers.Add(ob);
