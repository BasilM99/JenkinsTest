...
{
    public class User : IEntity<int>, ITenant<int>
    {
        ...
        public virtual global::ArabyAds.AdFalcon.Domain.Model.Account.Account LastAccountLogin
        {
            get
           ;
            set;
        }
        public virtual global::ArabyAds.AdFalcon.Domain.Model.Account.Account Account
        {
            get
            {
