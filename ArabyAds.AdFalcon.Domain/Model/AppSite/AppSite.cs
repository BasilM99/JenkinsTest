...
namespace ArabyAds.AdFalcon.Domain.Model.AppSite
{
    public class AppSite : IEntity<int>
    {
        ...
        public virtual void RemoveAppKeyword(AppSiteKeyword keyword)
        {
            AppSiteKeyword appSiteKeyword = Keywords.Where(p => p.ID == keyword.ID).SingleOrDefault();
        ...
        public virtual void ChangeServerSetting(AppSiteServerSetting appSiteServerSetting)
        {
            ...
            this.AppSiteServerSetting.SupportedBannerImageTypes = !string.IsNullOrWhiteSpace(appSiteServerSetting.SupportedBannerImageTypes) ? appSiteServerSetting.SupportedBannerImageTypes : null;
        ...
        public virtual void ResetServerSetting()
        {
            if (this.AppSiteServerSetting != null)
            {
                ...
                this.AppSiteServerSetting.SupportedBannerImageTypes = null;
            }
        }
        ...
        public virtual void Validate(bool checkSecurity, bool statusCheck = false)
        {
            ...
            if (checkSecurity)
            {
                if ((this.Account != null) && (this.Account.ID != Framework.OperationContext.Current.UserInfo<ArabyAds.Framework.UserInfo.IUserInfo>().AccountId))
                {
