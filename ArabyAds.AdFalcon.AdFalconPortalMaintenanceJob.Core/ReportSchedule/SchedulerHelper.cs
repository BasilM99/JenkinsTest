    ...
    public static class SchedulerHelper
    {
       ...
       public static string DefaultLanguage;
        ...
        public static void InitializeSchedulerHelper()
        {
            ...
            ResourceService = IoC.Instance.Resolve<ArabyAds.Framework.Resources.IResourceService>();
            ConfigurationManager = Framework.IoC.Instance.Resolve<ArabyAds.Framework.ConfigurationSetting.IConfigurationSettingService>();
            SchedulerFactory = new StdSchedulerFactory();
            DefaultLanguage = JsonConfigurationManager.AppSettings["DefaultLanguage"];
        ...
        {
            var triggers = context.Scheduler.GetTriggersOfJob(context.JobDetail.Key).Result;
            if (triggers != null)
            {
