...
function getBid(isLoadHandler, showSpinner) {
    ...
    sendData.Demographic = getdegetdemographicsInfo
...
function checkStatus(IsContinue) {
    ...
    result = checkBid() && result && !disableSaveButtonForAjax && BudgetChanged() && validateConversions() && CheckBidModifierDuplication();
    if (has_device_targeting) {
