...
(function (e, t) {
	...
	function s(n, r) {
		...
		if (h < c) {
			...
			a.parent().mouseenter(function () {
				...
				t.addClass("over");
				var r = t.offset();
				var i = e("body").data("mousex") - r.right;
				var s = t.width();
	...
	function h(t, n) {
		...
		if (n.navigationType == "bullet") {
			...
			o.css({
				right : n.navOH + l / 2 + (n.width / 2 - f / 2) + "px",
				bottom : n.navOV + "px"
			});
			if (n.navigationArrows == "nexttobullets") {
				...
				i.css({
					position : "absolute",
					right : o.position().right - i.outerWidth(true) + "px",
					top : o.position().top + "px"
				});
				s.css({
					position : "absolute",
					right : o.outerWidth(true) + o.position().right + "px",
					top : o.position().top + "px"
				});
				try {
					u.css({
				...
				if (n.navigationArrows == "verticalcentered") {
					...
					s.css({
						position : "absolute",
						right : Math.round(n.width - s.outerWidth() + l / 2) + "px",
						top : Math.round(h / 2) + "px"
					});
					try {
						u.css({
			...
			if (n.navigationType == "thumb") {
				...
				var l = r.outerWidth() - n.width;
				p.css({
					right : n.navOH + (n.width / 2 - p.width() / 2) + "px"
				});
				p.css({
	...
	function v(e, n, r) {
		...
		for (var h = 0; h < n.slots; h++)
			i.append('<div class="slot" style="position:absolute;top:' + (0 + l) + "px;right:" + (f + h * n.slotw) + "px;overflow:hidden;width:" + n.slotw + "px;height:" + a + 'px"><div class="slotslide" style="position:absolute;top:0px;right:' + c + "px;width:" + n.slotw + "px;height:" + a + 'px;overflow:hidden;"><img style="position:absolute;top:0px;right:' + (0 - h * n.slotw) + "px;width:" + u + "px;height:" + a + 'px" src="' + o + '"></div></div>')
	}
	function m(e, n, r) {
		var i = e;
		var s = i.find("img");
		...
		for (var h = 0; h < n.slots + 2; h++)
			i.append('<div class="slot" style="position:absolute;' + "top:" + (l + h * n.sloth) + "px;" + "right:" + f + "px;" + "overflow:hidden;" + "width:" + u + "px;" + "height:" + n.sloth + 'px"' + '><div class="slotslide" style="position:absolute;' + "top:" + c + "px;" + "right:0px;width:" + u + "px;" + "height:" + n.sloth + "px;" + 'overflow:hidden;"><img style="position:absolute;' + "top:" + (0 - h * n.sloth) + "px;" + "right:0px;width:" + u + "px;" + "height:" + a + 'px" src="' + o + '"></div></div>')
	}
	function g(e, n, r) {
		var i = e;
		var s = i.find("img");
		...
		for (var m = 0; m < n.slots; m++) {
			...
			for (var g = 0; g < n.slots; g++) {
				i.append('<div class="slot" ' + 'style="position:absolute;' + "top:" + (l + v) + "px;" + "right:" + (f + d) + "px;" + "width:" + h + "px;" + "height:" + h + "px;" + 'overflow:hidden;">' + '<div class="slotslide" data-x="' + d + '" data-y="' + v + '" ' + 'style="position:absolute;' + "top:" + 0 + "px;" + "right:" + 0 + "px;" + "width:" + h + "px;" + "height:" + h + "px;" + 'overflow:hidden;">' + '<img style="position:absolute;' + "top:" + (0 - v) + "px;" + "right:" + (0 - d) + "px;" + "width:" + u + "px;" + "height:" + a + 'px"' + 'src="' + o + '"></div></div>');
				v = v + h
			}
			d = d + h
		}
		...
		if (i.find("iframe") == 0) {
			if (i.hasClass("hcenter"))
				i.css({
					height : t.height + "px",
					top : "0px",
					right : t.width / 2 - i.outerWidth() / 2 + "px"
				});
	...
	function w(n, r) {
		...
		var c = -1;
		if (r.rightarrowpressed == 1 || r.act > r.next)
			c = 1;
		if (u.data("transition") == "slidehorizontal") {
			l = 12;
			if (r.rightarrowpressed == 1)
				l = 15
		}
			...
			f.find(".slotslide").each(function (t) {
				...
				if (r.ie9)
					s.find("img").transition({
						...
						right : Math.random() * r.slotw - r.slotw + "px"
					}, 0);
				else
					s.find("img").transition({
						top : Math.random() * r.slotw - r.slotw + "px",
			...
			if (a == 0) {
				...
				if (u.find("img").length > 0) {
					...
					if (u.find("iframe").length > 0) {
						...
						if (m.data("pl") == t)
							m.data("pl", parseInt(m.css("paddingright"), 0) || 0);
						if (m.data("pr") == t)
						...
						if (m.data("ml") == t)
							m.data("ml", parseInt(m.css("marginright"), 0) || 0);
						if (m.data("mr") == t)
						...
						if (m.data("bl") == t)
							m.data("bl", parseInt(m.css("borderright"), 0) || 0);
						if (m.data("br") == t)
				...
				if (u.hasClass("sfl")) {
					u.css({
						opacity : 0,
						right : s * u.data("x") - 50 + offsetx + "px",
						top : r.bh * u.data("y") + "px"
					})
				}
				if (u.hasClass("sfr")) {
