...
using Filter = ArabyAds.AdFalcon.Web.Controllers.Model.Campaign.Filter;
using ListViewModel = ArabyAds.AdFalcon.Web.Controllers.Model.Campaign.ListViewModel;
...
namespace ArabyAds.AdFalcon.Administration.Web.Controllers.Core
{
    ...
    public class HouseAdController : CampaignController
    {
        ...
        #region Ad Groups
        protected override AdGroupCriteria GetAdGroupCriteria(ArabyAds.AdFalcon.Web.Controllers.Model.Campaign.Filter filter)
        {
        ...
        #endregion
        private AppSiteListResultDto getAppSiteQueryResult(AppSiteCriteriaModel appCriteria)
        {
        ...
        public JsonResult GetAppSitesDropDown(int appID)
        {
            ...
            var result = getAppSiteQueryResult(appCriteria);
        ...
        [GridAction(EnableCustomBinding = true)]
        public ActionResult GetAppSites(int? filterType, int? appId)
        {
