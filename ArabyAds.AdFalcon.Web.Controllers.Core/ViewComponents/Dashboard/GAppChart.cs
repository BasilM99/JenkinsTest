...
namespace ArabyAds.AdFalcon.Web.Controllers.Core.ViewComponents.Dashboard
{
    ...
    public class GAppChart : ViewComponent
    {
       ...
       int? page, string orderBy)
        {
            ...
            List<AppSiteGeoLocationDto> aGeoLocationList = new List<AppSiteGeoLocationDto>();
            ViewData["AppSiteGeoLocation"] = aGeoLocationList;
