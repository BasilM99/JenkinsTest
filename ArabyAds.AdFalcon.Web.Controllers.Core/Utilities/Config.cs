...
namespace ArabyAds.AdFalcon.Web.Controllers.Utilities
{
    public static class Config
    {
        ...
        private static string defaultAccountAdvertiserAction = string.Empty;
        ...
        public static decimal? _MaxBidModifierValue;
        public static decimal? _MinBidModifierValue;

        public static decimal MaxBidModifierValue
        {
            get
            {
                if (!(_MaxBidModifierValue.HasValue))
                {
                    _MaxBidModifierValue = Convert.ToDecimal(ConfigurationManager.GetConfigurationSetting(null, null, "MaxBidModifierValue"));
                }

                return _MaxBidModifierValue.Value;
            }
        }
        public static decimal MinBidModifierValue
        {
            get
            {
                if (!(_MinBidModifierValue.HasValue))
                {
                    _MinBidModifierValue = Convert.ToDecimal(ConfigurationManager.GetConfigurationSetting(null, null, "MinBidModifierValue"));
                }

                return _MinBidModifierValue.Value;
            }
        }
        public static decimal AppSiteRevenuePercentage
        {
        ...
        public static bool IsFinanceManager
        {
            get
            {
                return IsInRole("FinanceManager");
            }
        }
        ...
        public static int? ApplicationId
        {
            get
            {
                ...
                {
                    int temp;
                    if (int.TryParse(JsonConfigurationManager.AppSettings["ApplicationId"], out temp))
                        applicationId = temp;
                }
        ...
        public static string DefaultActionAccountAdvertiser
        {
            get
            {
                if (string.IsNullOrWhiteSpace(defaultAccountAdvertiserAction))
                {
                    defaultAccountAdvertiserAction = "";
                    if (string.IsNullOrWhiteSpace(defaultAccountAdvertiserAction))
                    {
                        defaultAccountAdvertiserAction = "AccountAdvertisers";
                    }
                }
                return defaultAccountAdvertiserAction;
            }
        }
        ...
        public static string RootUrl
        {
            get
            {
                var returnUrl = HttpContextHelper.Current.Request.GetRawUrl().GetLeftPart(UriPartial.Authority) + HttpContextHelper.Current.Request.PathBase;
        ...
        public static bool IsAdfalconRevenueFee
        {
            get
            {
                if (configurationManager.GetConfigurationSetting(null, null, "IsAdfalconRevenueFee") != null || configurationManager.GetConfigurationSetting(null, null, "IsAdfalconRevenueFee") != string.Empty)
                {
                    return bool.Parse(configurationManager.GetConfigurationSetting(null, null, "IsAdfalconRevenueFee"));
                }
        ...
        public static bool IsAdfalconRevenueCostElem
        {
            get
            {
                if (configurationManager.GetConfigurationSetting(null, null, "IsAdfalconRevenueCostElem") != null || configurationManager.GetConfigurationSetting(null, null, "IsAdfalconRevenueCostElem") != string.Empty)
                {
                    return bool.Parse(configurationManager.GetConfigurationSetting(null, null, "IsAdfalconRevenueCostElem"));
                }
