...
namespace ArabyAds.AdFalcon.Persistence.Repositories.Reports
{
    public class ReportRepository : BaseReportRepository, IReportRepository
    {
        
        public ReportRepository(RepositoryImplBase<ChartDto, int> repository, ArabyAds.Framework.ConfigurationSetting.IConfigurationManager configurationManager)
