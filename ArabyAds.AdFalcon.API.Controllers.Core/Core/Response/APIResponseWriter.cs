...
namespace ArabyAds.AdFalcon.API.Controllers.Core.Response
{
    ...
    public static class APIResponseWriter
    {
        ...
        public static void WriteResponse(string data, bool endResponse, ActionContext context)
        {
           var response = context.HttpContext.Response;
           
            //response.Headers.ca = "no-cache";
            response.Clear();
        ...
        public static void WriteErrorResponse(APIException exception,bool endResponse,ActionContext context)
        {
            var response = context.HttpContext.Response;
            response.AddHeader("Cache-Control", "no-cache");
