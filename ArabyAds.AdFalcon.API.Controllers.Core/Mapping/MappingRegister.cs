...
namespace ArabyAds.AdFalcon.API.Controllers.Mapping
{
    public static class MappingRegister
    {
        ...
        private static MapperConfigurationExpression cfg;
        ...
        private static void RegisterAppSiteStatsCriteriaToReportCtiteriaDto()
        {
            ...
            cfg.CreateMap<AppSiteStatsCriteria, AppSiteStatisticsCriteriaDto>()
                .ForMember(p => p.FromDate, x => x.MapFrom((p, dest) =>
                    {
                        return DateTime.ParseExact(p.FDate, requestDteTimeFormat, new CultureInfo("en-US"));
                    }))
                .ForMember(p => p.ToDate, x => x.MapFrom((p, dest) =>
                {
                    return DateTime.ParseExact(p.TDate, requestDteTimeFormat, new CultureInfo("en-US"));
                }))
                .ForMember(p => p.PageNumber, x => x.MapFrom((p, dest) =>
                {
                    return p.OS;
                }))
            .ForMember(p => p.ItemsPerPage, x => x.MapFrom((p, dest) =>
                {
                    return p.L;
                }))
            .ForMember(p => p.Layout, x => x.MapFrom((p, dest) =>
            {
                return "detailed";
            }))
            .ForMember(p => p.SummaryBy, x => x.MapFrom((p, dest) =>
            {
            ...
            .ForMember(p => p.ItemsList, x => x.MapFrom((p, dest) =>
            {
            ...
            .ForMember(p => p.AdvancedCriteria, x => x.MapFrom((p, dest) =>
            {
            ...
            .ForMember(p => p.GroupBy, x => x.MapFrom((p, dest) =>
            {
