...
namespace ArabyAds.AdFalcon.Domain
{
        ...
        public static string WebAPIHostAdServer
        {
            get
            {
                if (_WebAPIHostAdServer == null)
                {
                    ...
                    _WebAPIHostAdServer = JsonConfigurationManager.AppSettings["WebAPIHostAdServer"];
                }
        ...
        public static Id64Generator Id64Generator
        {
            get
            {
                if (_id64Generator == null)
                {
                    ...
                    _id64Generator = new Id64Generator(int.Parse(JsonConfigurationManager.AppSettings["HostId"]));
                }
...
public static bool IsAdminOnly
        ...
        public static bool SendAdServerEmails
        {
            get
            {
                    ...
                    bool.TryParse(ConfigurationManager.GetConfigurationSetting(ApplicationContext.Instance.Tenant!=null ? ApplicationContext.Instance.Tenant.ID : null , null , "SendAdServerEmails"), out _sendAdServerEmails);
        ...
        public static string EventBrokerEmail
        {
            get
            {
                return ConfigurationManager.GetConfigurationSetting(ApplicationContext.Instance.Tenant != null ? ApplicationContext.Instance.Tenant.ID : null, null,"EventBrokerEmail");
        ...
        public static string FinanceEmail
        {
            get
            {
                 ...
                 return ConfigurationManager.GetConfigurationSetting(ApplicationContext.Instance.Tenant != null ? ApplicationContext.Instance.Tenant.ID : null, null, "FinanceEmail");
        ...
        public static string AdOpsEmail
        {
            get
            {
                ...
                {
                    adOpsEmail = ConfigurationManager.GetConfigurationSetting(ApplicationContext.Instance.Tenant != null ? ApplicationContext.Instance.Tenant.ID : null, null, "AdOpsEmail");
                }
                return adOpsEmail;
            }
        }
        public static string EmailAdmin
        {
            get
            {
                return ConfigurationManager.GetConfigurationSetting(ApplicationContext.Instance.Tenant != null ? ApplicationContext.Instance.Tenant.ID : null, null , "EmailAdmin");
             
            }
        }
        public static string EmailAdminTenant
        {
            get
            {
        ...
        public static string NoReplyTenant
        {
            get
            {

                return ConfigurationManager.GetConfigurationSetting(ApplicationContext.Instance.Tenant != null ? ApplicationContext.Instance.Tenant.ID : null, null, "NoReplyEmail");
        ...
        public static string CdnBaseUrl
        {
            get
            {
               return ConfigurationManager.GetConfigurationSetting(ApplicationContext.Instance.Tenant != null ? ApplicationContext.Instance.Tenant.ID : null, null, "cdnBaseUrl");
        ...
        public static IEventPublisher KafkaEventPublisher
        {
            get
            {
                ...
                {
                    _KafkaEventPublisher = EventPublisher.Create(JsonConfigurationManager.AppSettings["KafkaTopic"].ToString(), JsonConfigurationManager.AppSettings["HostId"].ToString(), "event.pubsub");
        ...
        private static ISubscriptionProxy _eventBrokerSubscription;
        public static ISubscriptionProxy EventBrokerSubscription
        {
            get
            {
                if (_eventBrokerSubscription == null)
                {

                    var evenBrokerconfiguration = new SubscriptionProxyConfig
                    {
                        LoggerName = "event.pubsub",
                        ProxyId = JsonConfigurationManager.AppSettings["event.pubsub.subscriberId"],
                        OffsetTrackingMode = OffsetTrackingMode.Auto,
                        ZooKeeperTimeout = TimeSpan.FromMinutes(1),
                        ZooKeeperUrl = JsonConfigurationManager.AppSettings["event.pubsub.zkServiceUrl"],
                        ZooKeeperConnectionStr = JsonConfigurationManager.AppSettings["event.pubsub.zkConnectionString"]
                    };
                    EventSubscriptionProxy.Create(evenBrokerconfiguration).Init();
                    _eventBrokerSubscription = EventSubscriptionProxy.Current;
                }
                return _eventBrokerSubscription;
            }
        }
