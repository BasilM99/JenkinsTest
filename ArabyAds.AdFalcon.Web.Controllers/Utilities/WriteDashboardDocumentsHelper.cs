...
namespace Noqoush.AdFalcon.Web.Controllers.Utilities
{
    ...
    {
        public FileStreamResult BuildAppGeoLocationExportFile(List<AppSiteGeoLocationDto> appsiteGeoLocation, string type, List<KeyValueDto> keyValueDtos)
        {
            using (MemoryStream memDocument = new MemoryStream())
            {
                ...
                switch (type.ToLower())
                {
                    case "pdf":
                        ...
                        HttpContext.Current.Response.AddHeader("content-disposition", "attachment;filename=Statistics.pdf");
                        ...
                        streamResult = new FileStreamResult(HttpContext.Current.Response.OutputStream, "application/pdf");
                    ...
                    case "excel":
                        ...
                        HttpContext.Current.Response.AddHeader("content-disposition", "attachment;filename=Statistics.xls");
                        ...
                        streamResult = new FileStreamResult(HttpContext.Current.Response.OutputStream, "application/vnd.ms-excel");
                        break;
                    case "csv":
                        ...
                        HttpContext.Current.Response.ClearHeaders();
                        HttpContext.Current.Response.ClearContent();
                        HttpContext.Current.Response.AddHeader("content-disposition", "attachment;filename=Statistics.csv");
                        ...
                        streamResult = new FileStreamResult(HttpContext.Current.Response.OutputStream, "text/csv");
                        break;
                    default:
        ...
        public FileStreamResult BuildDealPerformanceExportFile(List<DealPerformanceDto> DealPerformanceList, string type, List<KeyValueDto> keyValueDtos, string NameTitle = "")
        {
            using (MemoryStream memDocument = new MemoryStream())
            {
                FileStreamResult streamResult;
                ...
                switch (type.ToLower())
                {
                    case "pdf":
                        ...
                        //prepare output stream
                        HttpContext.Current.Response.ContentType = "application/pdf";
                        HttpContext.Current.Response.AddHeader("content-disposition", "attachment;filename=Performance.pdf");
                        HttpContext.Current.Response.Buffer = true;
                        HttpContext.Current.Response.Clear();
                        HttpContext.Current.Response.OutputStream.Write(memDocument.GetBuffer(), 0, memDocument.GetBuffer().Length);
                        HttpContext.Current.Response.OutputStream.Flush();
                    ...
                    case "excel":
                        ...
                        HttpContext.Current.Response.ClearContent();
                        HttpContext.Current.Response.ContentType = "application/vnd.ms-excel";
                        HttpContext.Current.Response.AddHeader("content-disposition", "attachment;filename=Performance.xls");
                        HttpContext.Current.Response.HeaderEncoding = Encoding.UTF8;
                        HttpContext.Current.Response.AddHeader("Pragma", "public");
                        HttpContext.Current.Response.ContentEncoding = Encoding.Unicode;
                        // Start the feed with BOM
                    ...
                    case "csv":
                        ...
                        HttpContext.Current.Response.ClearHeaders();
                        HttpContext.Current.Response.ClearContent();
                        HttpContext.Current.Response.AddHeader("content-disposition", "attachment;filename=Performance.csv");
                        HttpContext.Current.Response.ContentType = "text/csv";
                        HttpContext.Current.Response.HeaderEncoding = Encoding.UTF8;
                        HttpContext.Current.Response.AddHeader("Pragma", "public");
                        HttpContext.Current.Response.ContentEncoding = Encoding.Unicode;
        ...
        public FileStreamResult BuildAppPerformanceExportFile(List<AppSitePerformanceDto> appsitePerformanceList,  string type , List<KeyValueDto> keyValueDtos)
        {
            using (MemoryStream memDocument = new MemoryStream())
            {
                FileStreamResult streamResult;
        ...
        public FileStreamResult BuildAdGeoLocationExportFile(List<AdGeoLocationDto> adGeoLocation, string type ,List<KeyValueDto> keyValueDtos)
        {
            using (MemoryStream memDocument = new MemoryStream())
            {
                FileStreamResult streamResult;
        ...
        public FileStreamResult BuildAdPerformanceExportFile(List<AdPerformanceDto> adGeoLocation, string type  , List<KeyValueDto> keyValueDtos)
        {
            using (MemoryStream memDocument = new MemoryStream())
            {
                FileStreamResult streamResult;
        ...
        public FileStreamResult BuildImpressionLogPerformanceExportFile(List<ImpressionLogPerformanceDto> ImpressionLogPerformanceList, string type, bool showCampaign, bool showAdvertiser, List<KeyValueDto> keyValueDtos, string NameTitle = "")
        {
            using (MemoryStream memDocument = new MemoryStream())
            {
                FileStreamResult streamResult;
        ...
        public FileStreamResult BuildIAudienceSegmentsPerformanceExportFile(List<AudienceSegmentDto> AudienceSegmentsPerformanceList, string type, bool showCampaign, bool showAdvertiser, List<KeyValueDto> keyValueDtos, string NameTitle = "")
        {
            using (MemoryStream memDocument = new MemoryStream())
            {
                IAccountService _AccountService = Noqoush.Framework.IoC.Instance.Resolve<IAccountService>(); 
               ...
               NameTitle = ResourcesUtilities.GetResource("Name", "Global");
                ...
                switch (type.ToLower())
                {
                    case "pdf":
                        ...
                        //prepare output stream
                        HttpContext.Current.Response.ContentType = "application/pdf";
                        HttpContext.Current.Response.AddHeader("content-disposition", "attachment;filename=Segments.pdf");
                        HttpContext.Current.Response.Buffer = true;
                        HttpContext.Current.Response.Clear();
                        HttpContext.Current.Response.OutputStream.Write(memDocument.GetBuffer(), 0, memDocument.GetBuffer().Length);
                        HttpContext.Current.Response.OutputStream.Flush();
                    ...
                    case "excel":
                       ...
                       // strExcelWriter.Append("\t");
                        ...
                        foreach (var item in AudienceSegmentsPerformanceList)
                        {
                            if (item.IsPermissionNeed && !Domain.Configuration.IsAdmin && !_AccountService.checkAdPermissions(Domain.Common.Model.Core.PortalPermissionsCode.AudianceSegmentUsagePermission))
                            {
                                continue;
                            }
                        ...
                        HttpContext.Current.Response.ClearContent();
                        HttpContext.Current.Response.ContentType = "application/vnd.ms-excel";
                        HttpContext.Current.Response.AddHeader("content-disposition", "attachment;filename=Segments.xls");
                        HttpContext.Current.Response.HeaderEncoding = Encoding.UTF8;
                        HttpContext.Current.Response.AddHeader("Pragma", "public");
                        HttpContext.Current.Response.ContentEncoding = Encoding.Unicode;
                        // Start the feed with BOM
                    ...
                    case "csv":
                       ...
                       // strCSVWriter.Append("\t");
                        ...
                        HttpContext.Current.Response.ClearHeaders();
                        HttpContext.Current.Response.ClearContent();
                        HttpContext.Current.Response.AddHeader("content-disposition", "attachment;filename=Segments.csv");
                        HttpContext.Current.Response.ContentType = "text/csv";
                        HttpContext.Current.Response.HeaderEncoding = Encoding.UTF8;
                        HttpContext.Current.Response.AddHeader("Pragma", "public");
                        HttpContext.Current.Response.ContentEncoding = Encoding.Unicode;
