...
using Noqoush.AdFalcon.Persistence.ReportsGP.MinHashEstimator;
...
namespace Noqoush.AdFalcon.Persistence.RepositoriesGP.Reports
{
    ...
    {
        private string AVReportingGPA = System.Configuration.ConfigurationManager.AppSettings["ReportingGP"];
        ...
        public ReportGPRepository(RepositoryImplBase<ChartDto, int> repository, Noqoush.Framework.ConfigurationSetting.IConfigurationManager configurationManager)
