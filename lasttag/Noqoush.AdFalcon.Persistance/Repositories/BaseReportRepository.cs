...
namespace Noqoush.AdFalcon.Persistence.Reports.Repositories
{
    public class BaseReportRepository : RepositoryBase<ChartDto, int> 
    {
        ...
        public BaseReportRepository(RepositoryImplBase<ChartDto, int> repository, Noqoush.Framework.ConfigurationSetting.IConfigurationManager configurationManager)
            : base(repository)
        {
        ...
        protected List<T> GetResult<T>(string script)
        {
            ...
            using (var db = new Noqoush.AdFalcon.Persistence.Reports.Repositories.PetaPoco.Database("ReportingDB"))
            {
