...
namespace Noqoush.AdFalcon.Persistence.Reports.Repositories
{
    ...
    {
        public PerformanceReportRepository(RepositoryImplBase<ChartDto, int> repository, Noqoush.Framework.ConfigurationSetting.IConfigurationManager configurationManager)
