...
namespace Noqoush.AdFalcon.Services.Services.Account
{
    public class AccountService : IAccountService
    {
        ...
        public bool SaveAccountCostElement(AccountCostElementDto dto)
        {
            Party party = null;
        ...
        public void RemoveAccountCostElement(int Id)
        {


            var item = this._AccountCostElementRepository.Get(Id);
            if (item != null)
                this._AccountCostElementRepository.Remove(item);

        }
        public void EnableDisableAccountCostElement(int Id)
        {
        ...
        public AccountCostElementResultDto QueryAccountCostElements(Noqoush.AdFalcon.Domain.Common.Repositories.Account.AccountCostElementCriteria wcriteria)
        {
      ...
      public int AccountId { get; set; }*/
        ...
        public bool SaveAccountFee(AccountFeeDto dto)
        {
            Party party = null;
            AccountFee costAcc;
            bool existParty = false;
        ...
        public void RemoveAccountFee(int Id)
        {


            var item = this._AccountFeeRepository.Get(Id);
            if (item != null)
                this._AccountFeeRepository.Remove(item);

        }
        public void EnableDisableAccountFee(int Id)
        {
        ...
        public AccountFeeResultDto QueryAccountFees(Noqoush.AdFalcon.Domain.Common.Repositories.Account.AccountFeeCriteria wcriteria)
        {
      ...
      public int AccountId { get; set; }*/
        ...
        public TrialResultDto MainRootTrialQueryByCratiria(Noqoush.AdFalcon.Domain.Common.Repositories.Account.AuditTrialCriteria wcriteria)
        ...
        { 
            ...
            try
            {
                ...
                foreach (AuditTrialDto item in Items)
                {
                    ...
                    Trial.Name = GetRootObjectName(Trial.ObjectRootTypeId, item.RootObjectId, objectTypeName);
                    //Get object Type
                    if (objectType != null)
                    {
        ...
        public IList<ObjectTypeDto> getObjectTypes()
        {

            IList<ObjectType> types = _ObjectTypeRepository.GetRootObjects();
            IList<ObjectTypeDto> dtos = new List<ObjectTypeDto>();
        ...
        public void GetAuditTrialsMaxAndMin(int years, out long max, out long min)
        {

            try
            {
                _AuditTrialRepository.GetAuditTrialsMaxAndMin(years, out max, out min);
            }
            catch (Exception e)
            {
        ...
        public void GetAuditTrialSessionStatAliasMaxAndMin(int years, out long max, out long min)
        {

            try
            {
                _AuditTrialRepository.GetAuditTrialSessionStatAliasMaxAndMin(years, out max, out min);
            }
            catch (Exception e)
            {
        ...
        public void GetAuditTrialStatAliasMaxAndMin(int years, out long max, out long min)
        {

            try
            {
                _AuditTrialRepository.GetAuditTrialStatAliasMaxAndMin(years, out max, out min);
            }
            catch (Exception e)
            {
        ...
        #region delete Audit
        public void DeleteAuditTrials(long start, long end)
        {

            try
            {
                _AuditTrialRepository.DeleteAuditTrials(start, end);
        ...
        public void DeleteAuditTrialSessionStat(long start, long end)
        {

            try
            {
                _AuditTrialRepository.DeleteAuditTrialSessionStat(start, end);
        ...
        public void DeleteAuditTrialStat(long start, long end)
        {

            try
            {
                _AuditTrialRepository.DeleteAuditTrialStat(start, end);
        ...
        public IList<TrialDto> GetTrialSession(string id, bool isAdminApp)
        {
            ...
            foreach (var child in childrenItems)
            {
                ...
                {
                    var childReords = GetTrialDetailsSession(child.ID, isAdminApp, false);
        ...
        public IList<TrialDto> GetTrialDetailsSession(long Id, bool isAdminApp, bool CollectInfo = true)

        {
            //Guid guid = new Guid(id);

            IList<TrialDto> list = new List<TrialDto>();
            var details = _AuditTrialRepository.GetTrialDetailsSession(Id);
            ...
            System.Reflection.Assembly assembly = typeof(Noqoush.AdFalcon.Domain.Model.Account.Account).Assembly;
...

            {
                ...
                foreach (var child in listDes.PropertyList.props)
                {
                    ...
                    if (proprtyMetaData != null)
                    {
                        ...
                        var show = ObjectToShowOrNot(proprtyMetaData, PrortyInfor != null ? PrortyInfor.PropertyType : null, isAdminApp);
                        if (show)
                        {
                            if (CollectInfo)
                            {
        ...
        public IList<TrialDto> GetTrialSessions(Noqoush.AdFalcon.Domain.Common.Repositories.Account.AuditTrialCriteria wcriteria, out int total)
        {
            ...
            filter.UserId = 0;
            filter.PageSize = 10;
            var Items = _accountRepository.GeAuditTrialForObjectRootUsingStat(filter, out total).ToList();
            var GMT = Framework.Resources.ResourceManager.Instance.GetResource("UTC", "Global");
            var formatDate = _configurationManager.GetConfigurationSetting(1, null, "ShortDateFormat");
            var formatTime = _configurationManager.GetConfigurationSetting(1, null, "TimeFormat");
        ...
        public string GetRootObjectName(int RootObjectTypeID, int RootObjectId, string rootObjectTypeName)
        {
            ...
            string objectTypeName = rootObjectTypeName.Split('.').Last();
            if (!string.IsNullOrEmpty(objectTypeName))
            {
                switch (objectTypeName)
                {
                    case "ReportScheduler":
                        {
                            var rep = _ReportSchedulerRepository.Get(RootObjectId);

                            var jsonObj = new JavaScriptSerializer().Deserialize(rep.ReportCriteria != null ? rep.ReportCriteria.Criteria : rep.ReportJsonCriteria, typeof(ReportCriteriaDto));
                            var ReportCriteriaDto = (ReportCriteriaDto)jsonObj;

                            return rep.GetCompositeMame(ReportCriteriaDto.ItemsList, ReportCriteriaDto.TabId, false);
                    ...
                    case "AppSite":
                        ...
                        return _AppSiteRepository.GetObjectName(RootObjectId);


                    case "Campaign":
                        return _CampaignRepository.GetObjectName(RootObjectId);



                    case "Account":

                        return _accountRepository.GetObjectName(RootObjectId);
            ...
            )
        {
            ...
            if (!string.IsNullOrEmpty(objectTypeName))
            {
                switch (objectTypeName)
                {
                    case "Noqoush.AdFalcon.Domain.Model.Core.ReportScheduler":
                        {
                    ...
                    case "Noqoush.AdFalcon.Domain.Model.AppSite.AppSite":

                        return _AppSiteRepository.GetObjectName(ObjectId);


                    case "Noqoush.AdFalcon.Domain.Model.Campaign.Campaign":
                        return _CampaignRepository.GetObjectName(ObjectId);



                    case "Noqoush.AdFalcon.Domain.Model.Account.Account":

                        return _accountRepository.GetObjectName(ObjectId);
                    case "Noqoush.AdFalcon.Domain.Model.Campaign.AdGroup":
                    ...
                    default:
                        ...
                        {
                            //Noqoush.AdFalcon.Domain.Model.AppSite.AppSiteSetting gffggf;
                            if (ObjectT != null)
                            {
        ...
        public string GetRootObjectTypeNameValue(int RootObjectTypeID)
        {
            var objectType = _ObjectTypeRepository.Get(RootObjectTypeID);
            string objectTypeName = "";
        ...
        public string GetRootObjectTypeName(int RootObjectTypeID)
        {
            var objectType = _ObjectTypeRepository.Get(RootObjectTypeID);
            string objectTypeName = "";
        ...
        public int GetObjectRootTypeId(string objectRoot)
        {
            int id;
            try
            {
        ...
        public AccountPaymentDetailDto GetAccountPaymentDetails()
        {
            ...
            paymentinfo.TaxNumberRegex = GetVATTaxNoRegularExpression((int)OperationContext.Current.UserInfo<AdFalconUserInfo>().AccountId);
            return paymentinfo;
        }

        public bool CheckIfDocumentbelongToAccount(int documentId)
        {
            var currentAccount = _accountRepository.Get(OperationContext.Current.UserInfo<AdFalconUserInfo>().AccountId.Value);

            if (currentAccount.TaxRegistration != null && currentAccount.TaxRegistration.ID == documentId)
            {
                return true;
        ...
        public string GetAccountEmailAddress(int accountId)
        {
            var currentAccount = _accountRepository.Get(accountId);
        ...
        public string GetVATTaxNoRegularExpression(int accountId)
        {
            var currentacc = _accountRepository.Get(accountId);
        ...
        public IList<PaymentDetailDto> GetPaymentDetails(int accountId, PayemntAccountType accountType)
        {
            var list = _accountPaymentDetailsRepository.Query(x => x.Account.ID == accountId && x.IsActive && x.AccountType == accountType);
            return list.Select(x => MapperHelper.Map<PaymentDetailDto>(x)).ToList();
        }

        public IList<PaymentFullDetailDto> GetFullPaymentDetails(int accountId, PayemntAccountType accountType, PayemntAccountSubType subType)
        {
            var list = _accountPaymentDetailsRepository.Query(x => x.Account.ID == accountId && x.IsActive && x.AccountType == accountType && (x.SubType == PayemntAccountSubType.Both || x.SubType == subType));
        ...
        /// </summary>
        /// <returns></returns>
        public AccountDiscountDto GetAccountDiscount(int accountId)
        {
            var item = _accountDiscountRepository.Query(x =>
                 x.Account.ID == accountId && x.Discount.FromDate <= Framework.Utilities.Environment.GetServerTime() &&
        ...
        public AccountSettingDto GetAccountSetting(int accountId)
        {
            ...
            var item = _accountDiscountRepository.Query(x =>
                x.Account.ID == accountId && x.Discount.FromDate <= currentTime &&
        ...
        public AccountAPIAccessDto GetAccountAPIAccessByAPIClientId(string clientId)
        {
            if (!string.IsNullOrEmpty(clientId))
            {
                ...
                if (account != null)
                {
                    ...
                    return MapperHelper.Map<AccountAPIAccessDto>(account.APIAccess);
                }
            }
        ...
        public bool checkAdPermissions(PortalPermissionsCode Code)
        {
            ...
            bool result = _AccountPortalPermissionsRepository.checkAdPermissions(Code);

            return result;
        }

        public int GetAccountRole(int id)
        {
            int AccountRole = 0;
            if (_accountRepository.Get(id) != null)
                AccountRole = (int)_accountRepository.Get(id).AccountRole;
            else
        ...
        public ImpressionLogListResultDto ImpressionLogQueryByCratiria(Noqoush.AdFalcon.Domain.Common.Repositories.Campaign.ImpressionLogCriteria wcriteria)
        {
        ...
        public ImpressionLogDto GetImpressionLogById(int Id)
        {
            var impLog = _impressionLogRepository.Query(M => M.ID == Id).SingleOrDefault();
        ...
        public UserDto CreateAccount(Interfaces.DTOs.Account.UserDto userDtoInfo)
        {
            ...
            else
            {
                ...
                UserDto FinalUser = AutoMapper.Mapper.Map<User, UserDto>(Users[0]);
        ...
        public UserDto CreateUserAccount(Interfaces.DTOs.Account.UserDto userDtoInfo)
        {
            ...
            if (!userDtoInfo.AlreadyReg)
                addUserResult = _securityService.CreateUser(userDtoInfo.EmailAddress, userDtoInfo.Password, userDtoInfo.EmailAddress);
            if (userDtoInfo.AlreadyReg)
                addUserResult = true;
            if (addUserResult)
            {
                ...
                Noqoush.AdFalcon.Domain.Model.Account.Account Account = null;
                if (invitation != null)
                {
                ...
                UserDto FinalUser = AutoMapper.Mapper.Map<User, UserDto>(userInfo);
                return FinalUser;
            }
            else
            {
        ...
        {
            User userInfo = AutoMapper.Mapper.Map<UserDto, User>(userDtoInfo);
            if (!userDtoInfo.AlreadyReg)
            {
        ...
        public UserDto GetById(int id)
        {
            ...
            var item = _accountRepository.Get(id);
        ...
        public AdFalconUserInfo BuildAdFalconUser(int accountId, int userid, string emil)
        {
            var account = _accountRepository.Get(accountId);
            var userac= _UserAccountsRepositor.Query(X=>X.User.ID== userid && X.Account.ID == accountId).SingleOrDefault();
         var userobj=   _userRepository.Get(userid);
            if (account != null && (userac!=null))
            {
                var Permissions = _AccountPortalPermissionsRepository.GetAccountAdPermissions(accountId).Select(x => (int)x.Code).ToArray(); ;

                return new AdFalconUserInfo(userobj.FirstName, userobj.LastName, userobj.ID, accountId, account.UserAgreementVersion, account.AllowAPIAccess, account.PrimaryUser.ID == userid || (userac.UserType==UserType.Primary), Permissions, (int)account.AccountRole, account.GetVATValue(), userobj.EmailAddress, userobj.Company, (userac.UserType == UserType.ReadOnly));
            }
            else
                return null;
        }

        public IList<UserDto> GetUserAccounts(int userid)
        {
            var accounts = _UserAccountsRepositor.Query(M => M.User.ID == userid).Select(M => M.Account).ToList();
        ...
        {
            int accounts = _UserAccountsRepositor.Query(M => M.User.ID == userid).Select(M => M.Account).Count();

            return accounts;

        }

        public int GetFirstUserAccountId(int userid)
        {
            var accounts = _UserAccountsRepositor.Query(M => M.User.ID == userid).Select(M => M.Account).FirstOrDefault();
            if (accounts != null)
                return accounts.ID;
            else
                return 0;
        ...
        public int SaveDSPAccountSettingReport(AccountDSPsettingDTO itemDtoVar)
        {
        ...
        public AccountDSPsettingDTO GetDSPAccountSettingReport(int accountId)
        {
            var item = _DSPAccountSettingRepositor.Query(x => x.Account.ID == accountId).FirstOrDefault();
        ...
        public decimal GetVATValueByAccountId(int id)
        {
            Noqoush.AdFalcon.Domain.Model.Account.Account account = _accountRepository.Get(id);
            if (account != null)
            {
                return account.GetVATValue();
            }
            else
            {
                return 0;
        ...
        {
            Feature feature = _featureRepository.Query(x => (int)x.Code == code).FirstOrDefault();
