...
namespace Noqoush.AdFalcon.Administration.Web.Controllers
{
    public class AppOpsController : AuthorizedControllerBase
    {
        ...
        public AppOpsController(IAppSiteService appSiteService,
                                IAppSiteStatusService appSiteStatusService, IAppSiteTypeService appSiteTypeService, IPerformanceReportService performanceReportService,
                                ICountryService countryService, IUserService userService, IReportService reportService)
        {
