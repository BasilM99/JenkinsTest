...
namespace Noqoush.AdFalcon.Domain.Repositories.Campaign.Creative
{
    public class AdsCriteria : CriteriaBase<Model.Campaign.AdCreative>
    {
        ...
        public void CopyFromCommonToDomain(Noqoush.AdFalcon.Domain.Common.Repositories.Campaign.Creative.AdsCriteria Commoncr)
        {
    ...
    public class AdsSummaryCriteria : CriteriaBase<Model.Campaign.AdCreative>
    {
        ...
        public void CopyFromCommonToDomain(Noqoush.AdFalcon.Domain.Common.Repositories.Campaign.Creative.AdsSummaryCriteria Commoncr)
        {
            CampaignId = Commoncr.CampaignId;
