...
namespace Noqoush.AdFalcon.Domain.Repositories.Core
{
    public class PartyCriteria : CriteriaBase<Party>
    {
        ...
        public void CopyFromCommonToDomain(Noqoush.AdFalcon.Domain.Common.Repositories.Core.PartyCriteria Commoncr)
        {
    ...
    public class DPPartnerCriteria : CriteriaBase<DPPartner>
    {
        ...
        public void CopyFromCommonToDomain(Noqoush.AdFalcon.Domain.Common.Repositories.Core.DPPartnerCriteria Commoncr)
        {
            Visible = Commoncr.Visible;
            Name = Commoncr.Name;
            Code = Commoncr.Code;
