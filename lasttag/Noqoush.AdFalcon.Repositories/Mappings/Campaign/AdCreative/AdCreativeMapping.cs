...
{
    public class AdCreativeMapping : ClassMap<Noqoush.AdFalcon.Domain.Model.Campaign.AdCreative>
    {
        public AdCreativeMapping()
        {
            ...
            //Map(FluentNHibernate.Reveal.Member<Noqoush.AdFalcon.Domain.Model.Campaign.AdCreative>("DataBid"));
            //Map(x => x.MaxDataBid);
           // Map(x => x.UpdatedbyPortal).Nullable();
            

            Map(FluentNHibernate.Reveal.Member<Noqoush.AdFalcon.Domain.Model.Campaign.AdCreative>("Bid"));
    ...
    .Column("ParentId");
            HasMany(d => d.AdCreativeUnits).KeyColumn("AdId").Cascade.AllDeleteOrphan().Where(x => !x.IsDeleted).Inverse();
            ...
            Join("tracking_ads", w =>
             {
                 ...
                 w.References(M => M.AppMarketingPartner, "AppMarketingPartnerId").Not.Update().Cascade.None();
    ...
    public class AdExtensionMapping : ClassMap<Noqoush.AdFalcon.Domain.Model.Campaign.AdExtension>
    {
