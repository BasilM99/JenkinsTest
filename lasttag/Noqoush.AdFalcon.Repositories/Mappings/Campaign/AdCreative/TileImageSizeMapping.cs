...
{
    public class TileImageSizeMapping : ClassMap<Noqoush.AdFalcon.Domain.Model.Campaign.TileImageSize>
    {
        public TileImageSizeMapping()
        {
            ...
            HasMany(x => x.Formats).KeyColumn("TileImageSizeId").Cascade.All();
