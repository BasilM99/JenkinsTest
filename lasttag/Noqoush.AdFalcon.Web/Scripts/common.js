...
function postOptOutRequest() {
    ...
    if ($("#optoutEmail").val() != "") {
        var url = "../misc/OptOutRequest";

        if (window.location.protocol == "https:") {
            url = "../misc/OptOutHttpsRequest";
        }

        jQuery.post(url, $("#optoutEmail").val(), function (data) {
...
function ReadUserOptRequest() {

  
        var url = "../misc/ReadUserOpt";

        if (window.location.protocol == "https:") {
            url = "../misc/ReadUserOptHttps";
        }
...
function UpdateUserOptRequest() {

  
    var url = "../misc/UpdateUserOpt";

    if (window.location.protocol == "https:") {
        url = "../misc/UpdateUserOptHttps";
    }
    var value= $('#myonoffswitch').is("[checked]");
    value = !value;
    jQuery.post(url, { tracking:value }, function (data) {
