...
{
    public class PubReportController : Controller
    {
        private IReportService _reportService;

        public PubReportController(IReportService reportService)
        {
            _reportService = reportService;
        }

        public ActionResult Stats(AppSiteStatsCriteria criteria, bool isTest)
        {
            criteria.IsTest = isTest;
            BuildCriteria(ref criteria);
            ValidateCriteria(ref criteria);
            return GetAppSiteStatisticsReport(criteria);
        }
        ...
        private void BuildCriteria(ref AppSiteStatsCriteria criteria)
        {
            ...
            NameValueCollection jsonParameters = ConvertJSONParametersToNameValueCollection(Request.InputStream);
        ...
        private ActionResult GetAppSiteStatisticsReport(AppSiteStatsCriteria criteria)
        {
            ...
            try
            {
                reportCriteria = AutoMapper.Mapper.DynamicMap<AppSiteStatisticsCriteriaDto>(criteria);
            }
            ...
            reportCriteria.AccountId = int.Parse(CallContext.Current.Items["AccountId"].ToString());
