...
namespace Noqoush.AdFalcon.Domain.Model.Campaign
{
    public class RichMediaCreative : AdCreative
    {
        ...
        public override void Approve()
        {
            ...
            switch (AdSubType)
            {
                case Model.Campaign.AdSubTypes.ExpandableRichMedia:
                    {
                ...
                case Model.Campaign.AdSubTypes.HTML5Interstitial:
                case Model.Campaign.AdSubTypes.HTML5RichMedia:
                    {
                        var ftpBaseDirectory = Configuration.FtpBaseDirectory;
                        var cdnBaseUrl = Configuration.CdnBaseUrl;
                        ftpUpload(ftpBaseDirectory, cdnBaseUrl);
                ...
                case Model.Campaign.AdSubTypes.JavaScriptRichMedia:
                case Model.Campaign.AdSubTypes.JavaScriptInterstitial:
                case Model.Campaign.AdSubTypes.ExternalUrlInterstitial:
                    {
                        UploadSnapshots();
                        //nothing for now
                        break;
