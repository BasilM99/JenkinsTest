    ...
    public class AccountDSPRequest : IEntity<int>
    {
      ...
      //  public virtual string ApprovalNote { get; set; }
       ...
       // public virtual DateTime? ApprovedDate { get; set; }
        public virtual Noqoush.AdFalcon.Domain.Common.Model.Account.Account Approver { get; set; }

        public virtual Noqoush.AdFalcon.Domain.Common.Model.Account.Account Account { get; set; }
