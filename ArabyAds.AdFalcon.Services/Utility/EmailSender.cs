...
using ArabyAds.AdFalcon.Domain.Common.Model.Campaign.Targeting.Device;
...
@Fields</table>";
        ...
        public virtual void HandleEvent(EventArgsBase args)
        {
            ...
            _mailSender.SendEmail("", Domain.Configuration.NoReplyTenant, sendToEmails, subject, emailBody, true, bccEmailAddress);
        ...
        private string RegisterUser(EventArgsBase args)
        {
            ...
            if (ArabyAds.Framework.OperationContext.Current.UserInfo<ArabyAds.AdFalcon.Common.UserInfo.AdFalconUserInfo>().AccountId.HasValue)
            {
                var accountObj = accountRepository.Get(ArabyAds.Framework.OperationContext.Current.UserInfo<ArabyAds.AdFalcon.Common.UserInfo.AdFalconUserInfo>().AccountId.Value);
