...
namespace ArabyAds.AdFalcon.Services.Services.Account.SSP
{
    public class SupplyService : ISupplyService
    {
      ...
      IFloorPriceRepository floorPriceRepository,
        ...
        #region  Query Data
        public ResultPartnerDto QueryByCratiriaForPartner(ArabyAds.AdFalcon.Domain.Common.Repositories.Account.SSP.PartnerCriteria wcriteria)
        {
        ...
        public ResultPartnerSiteDto QueryByCratiriaForSitePartner(ArabyAds.AdFalcon.Domain.Common.Repositories.Account.SSP.PartnerSiteCriteria wcriteria)
        { 
        ...
        public ResultSiteZoneDto QueryByCratiriaForSiteZone(ArabyAds.AdFalcon.Domain.Common.Repositories.Account.SSP.SiteZoneCriteria wcriteria)
        {
        ...
        public ResultFloorPriceConfigDto QueryByCratiriaForFloorPrice(ArabyAds.AdFalcon.Domain.Common.Repositories.Account.SSP.FloorPriceCriteria wcriteria)
        {
        ...
        public ResultSiteZoneMapping QueryByCratiriaForSiteZoneMapping(ArabyAds.AdFalcon.Domain.Common.Repositories.Account.SSP.SiteZoneMappingCriteria wcriteria)
        {
        ...
        public ResultDealCampaignMappingDto QueryByCratiriaForDealCampaignMapping(ArabyAds.AdFalcon.Domain.Common.Repositories.Account.SSP.DealCampaignMappingCriteria wcriteria)
        {
        ...
        private void SetCampaingForDealing(ArabyAds.AdFalcon.Domain.Model.Campaign.Campaign camp)
        {
        ...
        public DealCampaignMappingDto GetDealCampaignMapping(ValueMessageWrapper<int> Id)
        {
            var item = new DealCampaignMapping();
            if (Id.Value > 0)
            {
                item = _dealCampaignMappingRepository.Get(Id.Value);
        ...
        public PartnerSiteDto GetSitePartner(ValueMessageWrapper<int> Id)
        {

            var item = new PartnerSite();
            if (Id.Value > 0)
            {
                item = _partnerSiteRepository.Get(Id.Value);
        ...
        public SiteZoneDto GetSiteZone(ValueMessageWrapper<int> Id)
        {
            var item = new SiteZone();
            if (Id.Value > 0)
            {
                item = _siteZoneRepository.Get(Id.Value);
        ...
        public FloorPriceConfigDto GetBaseFloorPrice(GetBaseFloorPriceRequest request)
        {

            var item = _floorPriceRepository.Query(M => M.Zone.ID == request.ZoneId && M.Site.ID == request.SiteId && M.ConfigType == FloorPriceConfigType.Base).SingleOrDefault();
            if (item != null)
            {
        ...
        public FloorPriceConfigDto GetFloorPrice(ValueMessageWrapper<int> Id)
        {
            var item = new FloorPrice();
            if (Id.Value > 0)
            {
                item = _floorPriceRepository.Get(Id.Value);
                var dto = MapperHelper.Map<FloorPriceConfigDto>(item);
                dto.ConfigTypeId = (int)dto.ConfigType;
                return dto;
        ...
        public void SaveFloorPrice(FloorPriceConfigDto dto)
        {
            ...
            else
            {
                ...
                if (item.ConfigType != FloorPriceConfigType.Base)
                {
                    bool isnew = false;
                    FloorPrice fpPrice = new FloorPrice();
                    var dtoFloorPrice = GetBaseFloorPrice(new GetBaseFloorPriceRequest { SiteId = dto.SiteID, ZoneId = dto.ZoneID });
        ...
        public void SaveSiteZoneMapping(SaveSiteZoneMappingRequest request)
        {

            SiteZoneMappingCriteria criteria = new SiteZoneMappingCriteria();
            criteria.SiteId = request.SiteZoneMappingDto.SiteID;
            criteria.ZoneId = request.SiteZoneMappingDto.ZoneID;
            var item = new SiteZoneMapping();
            if (request.SiteZoneMappingDto.ID > 0)
            {
                item = _siteZoneMappingRepository.Get(request.SiteZoneMappingDto.ID);
                criteria.ZoneId = item.Zone.ID;
                criteria.SiteId = item.Site.ID;
                if (request.SiteZoneMappingDto.DeviceTypeID > 0)
                    item.DeviceType = new DeviceType { ID = request.SiteZoneMappingDto.DeviceTypeID };
                else
                    item.DeviceType = null;

                if (request.SiteZoneMappingDto.AdTypeID > 0)
                    item.AdType = new AdType { ID = request.SiteZoneMappingDto.AdTypeID };
                else
                    item.AdType = null;

                item.IsInterstitial = request.SiteZoneMappingDto.IsInterstitial;
                var enquiryId = item.IsUniqueMapping(criteria);
                if (enquiryId != 0 && enquiryId != item.ID)
                {
                    throw new Exception("Duplicated Mapping");
            ...
            else
            {
                ...
                foreach (var appSite in request.AppSites)
                {
                    item = MapperHelper.Map<SiteZoneMapping>(request.SiteZoneMappingDto);
                    //if (dto.NativeLayoutId > 0)
                    //{
                    //    var appSite = _appSiteRepository.Get(appSiteId);
                    //    appSite.AppSiteServerSetting.ChangeNativeAdLayout(new NativeAdLayout { ID = dto.NativeLayoutId });
                    ...
                    {
                        //For Audit trial-To Do should be improved
                        item.Site = _partnerSiteRepository.Get(request.SiteZoneMappingDto.SiteID);
                        item.Site.Partner = _businessPartnerRepository.Get(item.Site.Partner.ID);
                        _siteZoneMappingRepository.Save(item);
                    }
                    else
            ...
            //For Audit trial-To Do should be improved
            if (item.Site == null && request.SiteZoneMappingDto.SiteID > 0)
                item.Site = _partnerSiteRepository.Get(request.SiteZoneMappingDto.SiteID);
            if (item.Site.Partner != null)
                item.Site.Partner = _businessPartnerRepository.Get(item.Site.Partner.ID);
        ...
        public SiteZoneMappingDto GetSiteZoneMapping(ValueMessageWrapper<int> Id)
        {
            var item = new SiteZoneMapping();
            if (Id.Value > 0)
            {
                item = _siteZoneMappingRepository.Get(Id.Value);
