...
using ArabyAds.AdFalcon.Persistence.RepositoriesGP.Reports;
...
namespace ArabyAds.AdFalcon.Services.Services.Reports
{
    public class ReportService : IReportService
    {
        ...
        private IDashBoardCriteriaRepository _DashBoardCriteriaRepository;
        ...
        public ReportService(IAdvertiserAccountRepository advertiserAccountRepository, IAdCreativeRepository adCreativeRepository, IAdGroupRepository adGroupRepository, IConfigurationManager configurationManager, IReportSchedulerRepository campaignReportSchedulerRepository, ICampaignRepository CampaignReportSchedulerRepository, IAccountRepository AccountRepository, IDocumentRepository DocumentRepository, IDocumentTypeRepository DocumentTypeRepository, IAppSiteRepository appSiteRepository, IReportRecipientRepository ReportRecipientRepository, IReportCriteriaRepository _reportCriteriaRepository, ImetriceColumnRepository metriceColumnRepository, ImetriceColumnReportCriteriaRepository _imetriceColumnReportCriteriaRepository,
            IAdvertiserRepository AdvertiserRepository
               ...
               , IMeasureRepository MeasureRepository
                   ...
                   , IDashBoardCriteriaRepository DashBoardCriteriaRepository, IKPIConfigRepository KPIConfigRepository
            ...
            )
        {
            ...
            this._DashBoardCriteriaRepository = DashBoardCriteriaRepository;

            this._KPIConfigRepository = KPIConfigRepository;
        }
        ...
        public List<ChartDto> GetAdChart(DashboardChartCriteria criteria)
        {
            ...
            criteria.IsPrimaryUser = userInfo.IsPrimaryUser;
            criteria.userId = userInfo.UserId.Value;
            return _ReportRepository.GetAdChart(criteria, userInfo.AccountId.Value);
        }
        ...
        public string GetCampaignName(ValueMessageWrapper<int> campaignId)
        {

            var name = _CampaignRepository.GetObjectName(campaignId.Value);
            return name;
        }
        ...
        public string GetAdGroupName(ValueMessageWrapper<int> Id)
        {

            var name = _AdGroupRepository.Query(M => M.ID == Id.Value).Select(M => M.Campaign.Name).SingleOrDefault<string>(); ;
            return name;
        }
        public string GetAdName(ValueMessageWrapper<int> Id)
        {

            var name = _AdCreativeRepository.Query(M => M.ID == Id.Value).Select(M => M.Group.Campaign.Name).SingleOrDefault<string>(); ;
            return name;
        }

        public string GetAdGroupNameForQ(ValueMessageWrapper<int> Id)
        {

            var name = _AdGroupRepository.Query(M => M.ID == Id.Value).Select(M => M.Name).SingleOrDefault<string>(); ;
            return name;
        }
        public string GetAdNameForQ(ValueMessageWrapper<int> Id)
        {

            var name = _AdCreativeRepository.Query(M => M.ID == Id.Value).Select(M => M.Name).SingleOrDefault<string>(); ;
            return name;
        }


        public string GetAppSiteName(ValueMessageWrapper<int> appSiteId)
        {

            var name = appSiteRepository.GetObjectName(appSiteId.Value);
            return name;
        }
        ...
        public void UpdateJobToSchduled(UpdateJobToSchduledRequest request)
        {
            var item = _ReportSchedulerRepository.Get(request.JobID);
            ...
            item.JobName = request.JobName;
            item.TriggerName = request.TriggerName;
            item.TriggerGroupName = request.TriggerGroupName;
            _ReportSchedulerRepository.Save(item);


            //if (NextFireTime.HasValue)
            //{
            item.NextFireTime = request.NextFireTime;

            //}
        }

        public void UpdateJobToSendNow(ValueMessageWrapper<int> jobID)
        {
            var item = _ReportSchedulerRepository.Get(jobID.Value);
        ...
        public void UpdateJobToNotFinished(ValueMessageWrapper<int> jobID)
        {
            var item = _ReportSchedulerRepository.Get(jobID.Value);
        ...
        public void UpdateJobToFinishedNoFireTime(ValueMessageWrapper<int> jobID)
        {
        ...
        public void UpdateJobToFinished(UpdateJobToFinishedRequest request)
        {
            var item = _ReportSchedulerRepository.Get(request.JobID);
        ...
        public ValueMessageWrapper<bool> UpdateJobToSchduledAfterRun(UpdateJobToSchduledAfterRunRequest request)
        {
            ...
            using (FileStream file = new FileStream(request.ReportFilePath, FileMode.Open, FileAccess.Read))
            {
            ...
            else
            {
                ...
                itemDocu.Name = Path.GetFileNameWithoutExtension(request.ReportFilePath);
                itemDocu.Content = bytes;
                itemDocu.UploadedDate = Framework.Utilities.Environment.GetServerTime();
        ...
        public ValueMessageWrapper<int> TestSaveSchadulingReport(testReportSchedulerDto reportSchedulerDto)
        {
            ...
            //if (item == null)
            //{
            //    item = new ArabyAds.AdFalcon.Domain.Model.Core.ReportScheduler();
        ...
        public ValueMessageWrapper<int> SaveSchadulingReport(ReportSchedulerDto reportSchedulerDto)
        {
            ...
            string json = JsonConvert.SerializeObject(reportSchedulerDto.ReportDto);

            if (item.ID == 0)
            {
                ReportCriteria ReportCriteria = new ReportCriteria
                {
                    Account = new ArabyAds.AdFalcon.Domain.Model.Account.Account
                    {
                        ID = OperationContext.Current.UserInfo<AdFalconUserInfo>().AccountId.Value,
                    },
                    User = new ArabyAds.AdFalcon.Domain.Model.Account.User
                    {
        ...
        public ResultReportSchedulerDto QueryByCratiriaForReportSchaduling(ArabyAds.AdFalcon.Domain.Common.Repositories.Core.ReportSchedulerCriteria wcriteria)
        {
            ...
            foreach (ReportSchedulerDto reportSchedulerDto in returnList)
            {
                ...
                var jsonObj = JsonConvert.DeserializeObject<ReportCriteriaDto>(criteriaItem != null ? criteriaItem.Criteria : reportSchedulerDto.ReportJsonCriteria);
                reportSchedulerDto.ReportDto = (ReportCriteriaDto)jsonObj;
                var rep = list.Where(M => M.ID == reportSchedulerDto.ID).Single();
                reportSchedulerDto.CompositeName = rep.GetCompositeMame(reportSchedulerDto.ReportDto.ItemsList, reportSchedulerDto.ReportDto.TabId, false, reportSchedulerDto.ReportDto.QueryJsonData);
        ...
        public ResultReportSchedulerDto QueryByCratiriaForReportCriteria(ArabyAds.AdFalcon.Domain.Common.Repositories.Core.ReportJsonCriteria wcriteria)
        {
        ...
        public ValueMessageWrapper<int> SaveReportCriteria(ReportCriteriaSchedulerDto reportSchedulerDto)
        {
        ...
        public ReportSchedulerDto GetSchadulingReport(ValueMessageWrapper<int> id)
        {


            var item = _ReportSchedulerRepository.Get(id.Value);
            ...
            var jsonObj = JsonConvert.DeserializeObject<ReportCriteriaDto>(item.ReportCriteria != null ? item.ReportCriteria.Criteria : item.ReportJsonCriteria);
            ...
            dto.ReportDto.RFromDate = dto.ReportDto.FromDate;
            dto.ReportDto.RToDate = dto.ReportDto.ToDate;
            ...
            dto.CompositeName = item.GetCompositeMame(dto.ReportDto.ItemsList, dto.ReportDto.TabId, false, dto.ReportDto.QueryJsonData);
        ...
        public ValueMessageWrapper<bool> DeleteSchadulingReport(ValueMessageWrapper<int> id)
        {
        ...
        public List<CampaignCommonReportDto> getAdvertisersListForDP(QueryDataProviderRequest request)
        {
            return _ReportRepository.getAdvertisersListForDP(request.DataProviderId, request.Culture, request.q, request.DateFrom, request.DateTo);
        }

        public List<CampaignCommonReportDto> getAgencyForDP(QueryDataProviderRequest request)
        {
            return _ReportRepository.getAgencyForDP(request.DataProviderId, request.q, request.DateFrom, request.DateTo);

        }

        public List<CampaignCommonReportDto> getCampaignForDP(QueryDataProviderRequest request)
        {
            return _ReportRepository.getCampaignForDP(request.DataProviderId, request.q, request.DateFrom, request.DateTo);
        }
        #endregion
        ...
        public metriceColumnDto GetColumn(ValueMessageWrapper<int> id)
        {
            metriceColumn Column = _metriceColumnRepository.Get(id.Value);
        ...
        public ValueMessageWrapper<int> GetColumnId(GetColumnIdRequest request)
        {

            return ValueMessageWrapper.Create(_metriceColumnRepository.GetColumnId(request.AppFieldName, request.Publisher));
        }
        public List<int> GetmetriceColumnsForTemplate(ValueMessageWrapper<int> TemplateId)
        {
            return _imetriceColumnReportCriteriaRepository.GetmetriceColumnsForTemplate(TemplateId.Value);
        }
        ...
        {
            List<CampaignCommonReportDto> results = _ReportRepository.GetCampaignSegmentReportTraficPlannerDrillDown(traficDto);
            return results;
        }

        #endregion

        public List<DataQBDto> GetResultofDataQBDto(GetResultofDataQBDtoRequest request)
        {


            string CountQuery = string.Format("SELECT Count(*) From ({0}) AS CountQueryResultSet", request.Script);
            string PaginationQuery = string.Format("SELECT * From ({0}) AS PaginationResultSet LIMIT {1}  OFFSET  {2}", request.Script, 10, (request.Page - 1) * 10);
            dynamic TotalCount = 0;
            dynamic results = null;
            if (string.IsNullOrEmpty(request.Ids))
                TotalCount = this._ReportRepository.GetResultofDataQBCount(CountQuery, request.OptionalDrop, request.MethodName);

            results = this._ReportRepository.GetResultofDataQBDto(PaginationQuery, request.OptionalDrop, request.MethodName);
        ...
        //public List<DataQBDto> GetResultofDataQBDtoMultiBid(GetResultofDataQBDtoRequest request)
        //{
        //    LookupCriteria criteria = new LookupCriteria();
        //    var repository = GetRepository<ICurrencyRepository>(request.LookupName);
        //   var lookupList = repository.Query(criteria.GetLookupExpression<Currency>(), criteria.Page - 1, 10, item => item.ID, true);
        //   var totalCount = repository.Query(criteria.GetLookupExpression<Currency>()).Count();
        //    List<DataQBDto> resultsD = new List<DataQBDto>();
        //               string CountQuery = string.Format("SELECT Count(*) From ({0}) AS CountQueryResultSet", request.Script);
        //    string PaginationQuery = string.Format("SELECT * From ({0}) AS PaginationResultSet LIMIT {1}  OFFSET  {2}", request.Script, 10, (request.Page - 1) * 10);


        //    var TotalCount = this._ReportRepository.GetResultofDataQBCount(CountQuery, request.OptionalDrop, request.MethodName);

        //    var results = this._ReportRepository.GetResultofDataQBDto(PaginationQuery, request.OptionalDrop, request.MethodName);

        //    Framework.ApplicationContext.Instance.Logger.InfoFormat("{0}:Execute-{1}", "GetResultofDataQBDto", PaginationQuery);
        //    if (lookupList != null)
        //    {

        //        foreach (var res in lookupList)
        //        {
        //            DataQBDto resd = new DataQBDto();
        //            resd.Name = res.Name.ToString();
        //            resd.Id = res.ID;
        //            resd.TotalCount = totalCount;
        //            resultsD.Add(resd);
        //        }
        //    }
        //    return results;
        ...
        public List<DataQBDto> GetResultofDataQBDtoWithScoping(GetResultofDataQBDtoWithScopingRequest request)
        {
        ...
        public FactDto GetFactById(ValueMessageWrapper<int> Id)
        {
            var item = this._FactRepository.Get(Id.Value);
            FactDto Fact = MapperHelper.Map<FactDto>(item);
            return Fact;
        }


        public List<ColumnQBDto> GetColumnsByFactId(GetColumnsByFactIdRequest request)
        {
            List<ColumnQB> columns = _FactRepository.Get(request.Id).Columns.OrderBy(x => x.DisplayName.ToString()).ToList();
        ...
        public List<MeasureDto> GetMeasuresByFactId(ValueMessageWrapper<int> Id)
        {
            List<Measure> columns = _FactRepository.Get(Id.Value).Measures.Where(x => !x.IsHidden).ToList();
        ...
        public MeasureDto GetMeasureById(ValueMessageWrapper<int> Id)
        {
            var item = this._MeasureRepository.Get(Id.Value);
            MeasureDto Fact = MapperHelper.Map<MeasureDto>(item);
            return Fact;
        }

        public ColumnQBDto GetColumnById(ValueMessageWrapper<int> Id)
        {
            var item = this._ColumnQBRepository.Get(Id.Value);
            ColumnQBDto Fact = MapperHelper.Map<ColumnQBDto>(item);
            return Fact;
        }

        public DimensionDto GetDimensionById(ValueMessageWrapper<int> Id)
        {
            var item = this._DimensionRepository.Get(Id.Value);
        ...
        public List<DimensionDto> GetDimensionsType()
        {
            var items = this._DimensionRepository.Query(M => M.DimensionType > 0);
            List<DimensionDto> mappeditems = items.Select(x => MapperHelper.Map<DimensionDto>(x)).ToList();
            foreach (var mapitem in mappeditems)
            {
                mapitem.Name = Framework.Resources.ResourceManager.Instance.GetResource(mapitem.DimensionTypeStr);
        ...
        public DimensionDto GetDimensionIdByType(ValueMessageWrapper<int> Id)
        {
            var item = this._DimensionRepository.Query(M => M.DimensionType == Id.Value).SingleOrDefault();
            DimensionDto Fact = MapperHelper.Map<DimensionDto>(item);


            return Fact;
        }
        public ValueMessageWrapper<int> GetMeasureCount(ValueMessageWrapper<int> Id)
        {
            var item = this._MeasureRepository.Query(x => x.ParentId == Id.Value).Count();

            return ValueMessageWrapper.Create(item);
        }

        public ValueMessageWrapper<int> GetColumnCount(ValueMessageWrapper<int> Id)
        {
            var item = this._ColumnQBRepository.Query(x => x.ParentId == Id.Value).Count();
            return ValueMessageWrapper.Create(item);
        }
        ...
        public List<string> Execute(ExecuteQueryRequest request)
        {

            request.Query = request.Query.Replace("TRUNC(", "(").Replace("trunc(", "(").Replace("ROUND(", "(").Replace("round(", "(").Replace("::float", "").Replace(",2R", "").Replace(" ,2R", "");

            IList<StringBuilder> rows = new List<StringBuilder>();
            if (string.IsNullOrEmpty(request.Query))
            {
                Framework.ApplicationContext.Instance.Logger.InfoFormat("{0}:Execute-{1}", "Query Builder", request.Query);
                return rows.Select(x => x.ToString()).ToList();
            }
            try
            {
                Framework.ApplicationContext.Instance.Logger.InfoFormat("{0}:Execute-{1}", "Report Builder-Export", request.Query);
                ...
                {
                    connection.Open();
                    using (NpgsqlCommand command = new NpgsqlCommand(request.Query, connection))
                    using (NpgsqlDataReader dataReader = command.ExecuteReader())
                    {

                       IList<string> updatedColumns = new List<string>();
                        IList<string> RowupdatedColumns = new List<string>();
                        var columns = Enumerable.Range(0, dataReader.FieldCount).Select(dataReader.GetName).ToList();
                        foreach (var col in columns )
                        {
                           var colscontent=  col.Split('#');
                            // var columns =
                            updatedColumns.Add(colscontent[1]);
                            RowupdatedColumns.Add(colscontent[0]);
                           
                        }
                       rows.Add(new StringBuilder(string.Join("^", RowupdatedColumns)));
            ...
            var stResult = GetUniqueColumns(request.DataModelDto, rows.ToList(), request.DataModelDto.accountId);
            return stResult.Select(x => x.ToString()).ToList();

        }

        public ResultDataSetQBDto ExecuteWithPagination(ExecuteWithPaginationRequest request)
        {
            ...
            try
            {
                request.Query = request.Query.Replace(",2R", ",2").Replace(" ,2R", " ,2");
                request.CountQuery = request.CountQuery.Replace(",2R", ",2").Replace(" ,2R", " ,2");

                string ConnectionName = "ReportingGPDB";
                string Connectionstring = JsonConfigurationManager.ConnectionStrings[ConnectionName] ?? "";
                request.Query = request.Query.Replace("LIMIT 10;", "");
                string CountQuery = string.Format("SELECT Count(*) From ({0}) AS CountQueryResultSet", request.CountQuery);
                string PaginationQuery = string.Empty;
                if (request.PageSize > 0)
                    PaginationQuery = string.Format("{0} LIMIT {1}  OFFSET  {2}", request.Query, request.PageSize, request.PageNumber * request.PageSize);
                else
                    PaginationQuery = string.Format("{0} ", request.Query, request.PageSize, request.PageNumber * request.PageSize);
                ...
                using (NpgsqlConnection connection = new NpgsqlConnection(Connectionstring))
                {
                    ...
                    using (NpgsqlDataReader dataReader = command.ExecuteReader())
                    {
                        ...
                        IList<int> updatedColumns = new List<int>();
                        IList<string> RowupdatedColumns = new List<string>();
                        foreach (var col in columns)
                        {
                            var colscontent = col.Split('#');
                            // var columns =
                            updatedColumns.Add(Convert.ToInt32(colscontent[1]));
                            RowupdatedColumns.Add(colscontent[0]);

                        }


                        resultSet.Columns = RowupdatedColumns;
                        resultSet.minWidthColumns = updatedColumns;
                        
                        rows.Add(new StringBuilder(string.Join("^", RowupdatedColumns)));
                        resultSet.Rows = new List<ValueMessageWrapper<IDictionary<string, string>>>();
                        ...
                        while (dataReader.Read())
                        {
                            ...
                            {
                                row[i] = dataReader.GetValue(i).ToString();
                                rowDic.Add(RowupdatedColumns[i], row[i]);
                            }
                            resultSet.Rows.Add(ValueMessageWrapper.Create(rowDic));
                            rows.Add(new StringBuilder(string.Join("^", row)));
            ...
            resultSet = GetUniqueColumns(request.DataModelDto, resultSet, request.DataModelDto.accountId);
            return resultSet;
       ...
       :
            ...
            if (ids != null)
            {
                ...
                switch (type)
                {
                    case "1":
                        ...
                        {
                            var node = GetColumnById(ValueMessageWrapper.Create(id));
                            int count = GetColumnCount(ValueMessageWrapper.Create(node.Id)).Value;
                    ...
                    case "2":
                        ...
                        foreach (var id in ids)
                        {
                            var node = GetMeasureById(ValueMessageWrapper.Create(id));
                            int childerCount = GetMeasureCount(ValueMessageWrapper.Create(node.Id)).Value;
        ...
        public ResultDataModelDto FilterResult(DataModelDto data)
        {
            ...
            FactDto fact = GetFactById(ValueMessageWrapper.Create(data.fact));
            ...
            if (Framework.OperationContext.Current.UserInfo<ArabyAds.Framework.UserInfo.IUserInfo>().IsPrimaryUser)
            {

                notAllowedadv = this._AccountStatistic.GetNotAllowedAdvertiserAsscoiation(Framework.OperationContext.Current.UserInfo<ArabyAds.Framework.UserInfo.IUserInfo>().AccountId.Value, Framework.OperationContext.Current.UserInfo<ArabyAds.Framework.UserInfo.IUserInfo>().UserId.Value);
            ...
            if (data.ColumnsIds != null)
            {
                ...
                {
                    var col = GetColumnById(ValueMessageWrapper.Create(data.ColumnsIds.ElementAt(i)));
                    if (col.Id == 24 || col.Id == 63)
                    {
                        if (data.SummaryBy == (int)SummaryBy.Day)
                        {
                            var coltemp = GetColumnById(ValueMessageWrapper.Create(29021));
                            col.DisplayName = coltemp.DisplayName;
                        }
                        else if (data.SummaryBy == (int)SummaryBy.Week)
                        {
                            var coltemp = GetColumnById(ValueMessageWrapper.Create(29022));
                            col.DisplayName = coltemp.DisplayName;

                        }
                        else if (data.SummaryBy == (int)SummaryBy.Month)
                        {
                            var coltemp = GetColumnById(ValueMessageWrapper.Create(29023));
                            col.DisplayName = coltemp.DisplayName;
                    ...
                    {
                        var coltemp = GetColumnById(ValueMessageWrapper.Create(29020));
                        col.DisplayName = coltemp.DisplayName;
                    ...
                    if (col != null)
                    {
                        ...
                        {
                            queryColumns.Add(string.Format(col.formatSQL, "  " + alias + "." + col.Attribute) + " as \"" + col.DisplayName + $"#{col.minWidth}\"");
                        }
                        else
                        {
                            queryColumns.Add("  " + alias + "." + col.Attribute + " as \"" + col.DisplayName + $"#{col.minWidth}\"");
            ...
            string subQueryCount = string.Empty;
            ...
            if (data.MeasuresIds != null)
            {
                ...
                {
                    var Measure = GetMeasureById(ValueMessageWrapper.Create(data.MeasuresIds.ElementAt(i)));
                    if (Measure != null)
                    {
                        if (string.IsNullOrEmpty(Measure.requestsmapping))
                        {
                            ...
                            {
                                queryMeasures.Add("  " + "" + Measure.SubstituteAttribute + " as \"" + Measure.DisplayName + $"#{Measure.minWidth}\"");
                            ...
                            {
                                queryMeasures.Add("  f" + "." + Measure.DisplayName.Replace(" ", "").Replace("/", "").Replace("-", "") + " as \"" + Measure.DisplayName + $"#{Measure.minWidth}\"");
                            ...
                            if (Measure.Id != 105)
                            {
                                if (!string.IsNullOrEmpty(filter))
                                {
                                    ...
                                    if (messureS != null)
                                    {
                                        ...
                                        {
                                            queryMeasures.Add("  " + "" + messureS.SubstituteAttribute + " as \"" + messureS.DisplayName +$"#{messureS.minWidth}\"");
                                        ...
                                        {
                                            queryMeasures.Add("  f" + "." + messureS.DisplayName.Replace(" ", "").Replace("/", "").Replace("-", "") + " as \"" + messureS.DisplayName + $"#{messureS.minWidth}\"");
            ...
            if (data.Querydata != null)
            {
                ...
                {
                    var dim = GetDimensionById(ValueMessageWrapper.Create(Convert.ToInt32(entry.Key)));
            ...
            if (!data.ForPublisher)
            {
                if (data.accountId > 0 && (fact.Name.Contains("deal") || fact.Name.Contains("unique_counters_")))
                {
                    subWhereQueries.Append(string.Format(" and ( accountid  = {0} )    and (impressions > 0)  ", data.accountId));
                    CopysubWhereQueries.Append(string.Format(" and ( accountid  = {0} )  and (impressions > 0)  ", data.accountId));
                ...
                {
                    if (!originalColumn.Contains(17000))
                    {
                        subWhereQueries.Append(string.Format(" and ( advaccountid  = {0} )  and (impressions > 0) ", data.accountId));

                        CopysubWhereQueries.Append(string.Format(" and ( advaccountid  = {0} )   and (impressions > 0) ", data.accountId));

                    }
                    else
                    {
                        subWhereQueries.Append(string.Format(" and ( advaccountid  = {0} ) and (dealid!=1)  and (impressions > 0)  ", data.accountId));
                        CopysubWhereQueries.Append(string.Format(" and ( advaccountid  = {0} )  and (dealid!=1)   and (impressions > 0)    ", data.accountId));
            ...
            {  //if (data.accountId > 0)
               // {
                subWhereQueries.Append(string.Format(" and ( pubaccountid  = {0} ) and campaigntype!=2   and (impressions > 0) ", data.accountId));

                CopysubWhereQueries.Append(string.Format(" and ( pubaccountid  = {0} ) and (campaigntype!=2)   and (impressions > 0)  ", data.accountId));
            ...
            if (result.isEnabledUniqueQuery)
            {
                ...
                {
                    queryMeasures.Add("  f" + ".campaignid" + " as \"UniqueKeyId" + $"#130\"");
                }
                else
                {
                    queryMeasures.Add("  f" + ".adgroupid" + " as \"UniqueKeyId" + $"#130\"");
                }
            ...
            if (customEvents)
            {
                ...
                var measurCodeEvkey = GetMeasureById( new ValueMessageWrapper<int> {  Value=139 });
                foreach (var evCode in customEventsCode)
                {
                    if (EventsName.Where(M => M.Code == evCode).SingleOrDefault() != null)
                    {
                        queryMeasures.Add("  f" + "." + EventsName.Where(M => M.Code == evCode).Single().Name.Replace(" ", "").Replace("/", "").Replace("-", "") + " as \"" + EventsName.Where(M => M.Code == evCode).Single().Name + $"#{measurCodeEvkey.minWidth}\"");
            ...
            List<string> subHeadersCount = secondSelectPartTempOne.ToList();
            List<string> subHeadersUnionCount = secondSelectPartTempOneUnion.ToList();
            ...
            string secondSelectCount = string.Join(",\n", subHeadersCount);
            Query = string.Empty;
            if (data.ColumnsIds.Count() == 0 && data.MeasuresIds.Count() == 0)
            {
                ...
                result.Query = Query;
                result.Warnings = warnings.ToString();
                return result;
            }
            else
            {
                ...
                string CopysubQueryCount = string.Empty;
                string CopysubQueryUnionCount = string.Empty;
                ...
                { tempQu = subQueryNoGroup;
                    ...
                    subQueryCount = string.Format(tempQu, secondSelectCount, fact.Name, subWhereQueries);

                    CopysubQueryCount = string.Format(tempQu, secondSelectCount, fact.Name, CopysubWhereQueries);
                ...
                else
                {
                    ...
                    subQueryCount = string.Format(tempQu, secondSelectCount, fact.Name, subWhereQueries, string.Join(",", secondSelectPartOne));

                    CopysubQueryCount = string.Format(tempQu, secondSelectCount, fact.Name, CopysubWhereQueries, string.Join(",", secondSelectPartOne));
                ...
                if (data.SummaryBy != (int)SummaryBy.Hour && data.SummaryBy != (int)SummaryBy.Day && fact.Name == "fact_stat_d")
                {
                    ...
                    ReportGeneratorArgs args2 = new ReportGeneratorArgs();
                    args2.WeekFactStatTable = "fact_stat_w";
                    args2.DayFactStatTable = "fact_stat_d";
                    args2.MonthFactStatTable = "fact_stat_m";
                    args2.SubQueryStr = "(" + CopysubQueryCount + ")";
                    args2.Criteria = new ReportCriteriaDto();
                    args2.Criteria.SummaryBy = data.SummaryBy;
                    args2.Criteria.FromDate = data.from.Value;
                    args2.Criteria.ToDate = data.to.Value;
                    ;
                    var resultsunionall2 = GenerateQueryScriptUnion(args2);
                    CopysubQueryUnionCount = resultsunionall2;
                    ...
                    if (isQueryAccum && resultsunionall.Contains("union"))
                    {
                        ...
                        result.CountQuery = CopysubQueryUnionCount;
                    }
                    else
                    {
                        result.CountQuery = CopysubQueryUnionCount;
                ...
                Query = queryFormat;
                result.Query = Query;
                result.CountQuery = subQueryCount;
                result.Warnings = warnings.ToString();
                return result;
                /* if (data.function != Function.Query)
                 {
        ...
        public List<StringBuilder> GetUniqueColumns(ResultDataModelDto dataConf, List<StringBuilder> results, int accountid)
        {
            if (results.Count > 1 && dataConf.isEnabledUniqueQuery)
            {
                ...
                {
                    if (dataConf.iscampUnique)
                        res = test.GetCardinalityEsitimator(Idtemps, false);
                    else
                ...
                for (var c = 1; c < results.Count; c++)
                {
                    ...
                    {
                        if (dataConf.iscampUnique)
                            arrStringtemp[indexforimpression] = res.Where(z => z.CampaignId == Convert.ToInt32(uniqueId)).Select(x => x.unique_impressions).FirstOrDefault().ToString();
                        else
                    ...
                    {
                        if (dataConf.iscampUnique)
                            arrStringtemp[indexforClicks] = res.Where(z => z.CampaignId == Convert.ToInt32(uniqueId)).Select(x => x.unique_clicks).FirstOrDefault().ToString();
                        else
                           arrStringtemp[indexforimpression] = res.Where(z => z.AdGroupId == Convert.ToInt32(uniqueId)).Select(x => x.unique_impressions).FirstOrDefault().ToString();
        ...
        public ResultDataSetQBDto GetUniqueColumns(ResultDataModelDto dataConf, ResultDataSetQBDto results, int accountid)
        {
            if (results.Rows.Count >= 1 && dataConf.isEnabledUniqueQuery)
            {
                ...
                {
                    var arrStringtemp = results.Rows[c].Value["UniqueKeyId"].ToString();
                ...
                for (var c = 0; c < results.Rows.Count; c++)
                {
                    ...
                    var uniqueId = results.Rows[c].Value["UniqueKeyId"].ToString();
                    ...
                    {
                        if (dataConf.iscampUnique)
                            results.Rows[c].Value["Unique Impressions"] = res.Where(z => z.CampaignId == Convert.ToInt32(uniqueId)).Select(x => x.unique_impressions).FirstOrDefault().ToString();
                        else
                            results.Rows[c].Value["Unique Impressions"] = res.Where(z => z.AdGroupId == Convert.ToInt32(uniqueId)).Select(x => x.unique_impressions).FirstOrDefault().ToString();

                    }
                    if ((dataConf.UniqueClicksImpressionNumb == 3 || dataConf.UniqueClicksImpressionNumb == 2) && indexforClicks > -1)
                    {
                        if(dataConf.iscampUnique)
                            results.Rows[c].Value["Unique Clicks"] = res.Where(z => z.CampaignId == Convert.ToInt32(uniqueId)).Select(x => x.unique_clicks).FirstOrDefault().ToString(); 
                        else
                            results.Rows[c].Value["Unique Clicks"] = res.Where(z => z.AdGroupId == Convert.ToInt32(uniqueId)).Select(x => x.unique_clicks).FirstOrDefault().ToString(); 
                    ...
                    results.Rows[c].Value.Remove("UniqueKeyId");
        ...
        public List<string> ExecuteAndFilterResult(DataModelDto data)
        {
            if (!string.IsNullOrWhiteSpace(data.QueryJsonData))
            {
                data.QueryJsonData = data.QueryJsonData.Replace("[", "\"");
                data.QueryJsonData = data.QueryJsonData.Replace("]", "\"");
            }
            ...
            var results = Execute(new ExecuteQueryRequest { Query = queryString.Query, DataModelDto = queryString }).Select(x => x.ToString()).ToList();
            return results;
        }
        ...
        public ValueMessageWrapper<int> SaveReportCriteriaForDashboard(ReportCriteriaDto dto)
        {
            var item = _DashBoardCriteriaRepository.Get(dto.ID);

            if (item != null && item.ReportScope == ReportCriteriaScope.System)
            {
                dto.ID = 0;

            }
            else if (item != null && dto.TypeSave == "Save")
            {

                dto.ID = 0;
            }
            var itemsQuery = _DashBoardCriteriaRepository.Query(M => (M.ReportScope == ReportCriteriaScope.User && M.Account.ID == Framework.OperationContext.Current.UserInfo<ArabyAds.Framework.UserInfo.IUserInfo>().AccountId.Value && M.SectionType == dto.SectionType) || (M.ReportScope == ReportCriteriaScope.System && M.SectionType == dto.SectionType));

            foreach (var criteriaItem in itemsQuery)
            {
                if (criteriaItem.ID != dto.ID && dto.Name.ToLower().Equals(criteriaItem.Name.ToLower()))
                    throw new BusinessException(new List<ErrorData>() { new ErrorData("DuplicatedCriteria") });
            }
            if (item == null || dto.ID == 0)
            {
                //  item = MapperHelper.Map<Domain.Model.Core.ReportCriteria>(reportSchedulerDto);
                item = new DashBoardCriteria();


                item.CreationDate = Framework.Utilities.Environment.GetServerTime();
                item.Account = new Domain.Model.Account.Account { ID = OperationContext.Current.UserInfo<AdFalconUserInfo>().AccountId.Value };
                //item.Criteria = JsonConvert.SerializeObject(dto);
                item.User = new Domain.Model.Account.User { ID = OperationContext.Current.UserInfo<AdFalconUserInfo>().UserId.Value };
                item.ReportScope = ReportCriteriaScope.User;
                item.SectionType = dto.SectionType;
                item.Name = dto.Name;
            }
            else
            {
            ...
            item.ForDashBoard = true;
            item.Criteria = JsonConvert.SerializeObject(dto);
            _DashBoardCriteriaRepository.Save(item);

            return ValueMessageWrapper.Create(item.ID);

        }

        public IList<ReportCriteriaDto> GetReportCriteriaForDashboard(ValueMessageWrapper<int> SectionType)
        {
            ReportSectionType sectoinTpeval = (ReportSectionType)SectionType.Value;
            var items = _DashBoardCriteriaRepository.Query(M => ((M.ReportScope == ReportCriteriaScope.User && M.Account.ID == OperationContext.Current.UserInfo<IUserInfo>().AccountId.Value && M.SectionType == sectoinTpeval) || (M.ReportScope == ReportCriteriaScope.System && M.SectionType == sectoinTpeval)) && M.ForDashBoard == true);

            IList<ReportCriteriaDto> results = new List<ReportCriteriaDto>();

            foreach (var item in items)
            {
                ReportCriteriaDto result = new ReportCriteriaDto();
                // result.Name = item.Name;
                result = JsonConvert.DeserializeObject<ReportCriteriaDto>(item.Criteria);
                result.Name = item.Name;
                result.ID = item.ID;
                results.Add(result);
        ...
        public ReportCriteriaDto GetReportCriteriaForDashboardById(ValueMessageWrapper<int> Id)
        {
            // ReportSectionType sectoinTpeval = (ReportSectionType)SectionType.Value;
            var item = _DashBoardCriteriaRepository.Query(M => (M.ID == Id.Value)).SingleOrDefault();
        ...
        #region dasbhboard Cards

        public void GetAdCreativeRequest(KPIFilterDto filters)
        {
            string todayPresent = filters.FromDate.ToString("ddMMyyyy");
            string datePresent = filters.FromDate.AddDays(-1).ToString("ddMMyyyy");
            string datePast = "0";
            if (filters.ToDate != filters.FromDate)
                datePast = filters.ToDate.ToString("ddMMyyyy");
            string advertiserFilter = "and AdvertiserAssociationId in (@AdvertiserId)";
            string advertiserStatment = @"select 
	
	present.Metric_1 ,  present.Metric_2 , 	present.Metric_3 ,  present.Metric_4 , 
	case 
		when past.Metric_1 = 0 and present.Metric_1 = 0 then 0
		when past.Metric_1 = 0 then 1
		when input.Duration = 0 then 0
		else power((present.Metric_1/past.Metric_1), 1 / input.Duration) - 1
	end * 100 GR_OverTime_Metric_1,
    
    	case 
		when past.Metric_2 = 0 and present.Metric_2 = 0 then 0
		when past.Metric_2 = 0 then 1
		when input.Duration = 0 then 0
		else power((present.Metric_2/past.Metric_2), 1 / input.Duration) - 1
	end * 100 GR_OverTime_Metric_2,
    	case 
		when past.Metric_3 = 0 and present.Metric_3= 0 then 0
		when past.Metric_3 = 0 then 1
		when input.Duration = 0 then 0
		else power((present.Metric_3/past.Metric_3), 1 / input.Duration) - 1
	end * 100 GR_OverTime_Metric_3,
    
    	case 
		when past.Metric_4 = 0 and present.Metric_4 = 0 then 0
		when past.Metric_4 = 0 then 1
		when input.Duration = 0 then 0
		else power((present.Metric_4/past.Metric_4), 1 / input.Duration) - 1
	end * 100 GR_OverTime_Metric_4,
from 
(
	select  min(day) min_day, max(day) max_day, count(day) Duration
	from adfalcon.advertisersperformance  
	where day between @past_day and @present_day and day < @today  @filter
	And EXISTS (SELECT * FROM advertiser_account
                WHERE advertiser_account.accountid = @accountid and advertiser_account.id =advertisersperformance.AdvertiserAssociationId )
    --group by CampaignId 
) input 
inner join 
(
	select Day, Clicks As Metric_1, Impressions As Metric_2, TotalSpend As Metric_3,common_schema.map_int_int_sum(Metrics)  as  Metric_4
	from adfalcon.advertisersperformance 
	where day between @past_day and @present_day  @filter
    
    And EXISTS (SELECT * FROM advertiser_account
                WHERE advertiser_account.accountid = @accountid and advertiser_account.id =advertisersperformance.AdvertiserAssociationId )
                
                
) present on (present.day = input.max_day )
inner join 
(
	select Day, Clicks As Metric_1 , Impressions As Metric_2, TotalSpend As Metric_3,common_schema.map_int_int_sum(Metrics)  as  Metric_4
	from adfalcon.advertisersperformance 
...
) past on (past.day = input.min_day );
";


            string campaignFilter = " and campaignId in (@campaignId)";
            string campaignStatment = @"select 
	-- Debug -- input.min_day, input.max_day, input.Duration,
	present.Metric_1 ,  present.Metric_2 , 	present.Metric_3 ,  present.Metric_4 , 
	case 
		when past.Metric_1 = 0 and present.Metric_1 = 0 then 0
		when past.Metric_1 = 0 then 1
...
(
	select  min(day) min_day, max(day) max_day, count(day) Duration
	from adfalcon.campaignsperformance  
	where day between @past_day and @present_day and day < @today  @filter
...
(
	...
	where day between @past_day and @present_day  @filter
            ...
            string dealsFilter = "and dealId in (@dealId)";
            string dealsStatment = @"select 
	-- Debug -- input.min_day, input.max_day, input.Duration,
	present.Metric_1 ,  present.Metric_2 , 	present.Metric_3 ,  present.Metric_4 , 
	case 
		when past.Metric_1 = 0 and present.Metric_1 = 0 then 0
...
(
	select  min(day) min_day, max(day) max_day, count(day) Duration
	from adfalcon.dealsperformance  
	where day between @past_day and @present_day and day < @today  @filter
...
";
            string publisherFilter = "and AppSiteId in (@AppSiteId)";
            string pulisherStatment = @"select 
	-- Debug -- input.min_day, input.max_day, input.Duration,
	present.Metric_1 
	case 
		when past.Metric_1 = 0 and present.Metric_1 = 0 then 0
...
(
	select  min(day) min_day, max(day) max_day, count(day) Duration
	from adfalcon.appsitesperformance  
	where day between @past_day and @present_day and day < @today  @filter
		And EXISTS (SELECT * FROM appsit
                WHERE appsit.accountid = @accountid and appsit.id =appsitesperformance.AppSiteId )
    --group by CampaignId 
) input 
inner join 
(
	select Day, Revenue As Metric_1
	from adfalcon.appsitesperformance 
	where day between @past_day and @present_day  @filter
    And EXISTS (SELECT * FROM appsit
                WHERE appsit.accountid = @accountid and appsit.id =appsitesperformance.AppSiteId )
...
";
            string dataProviderFilter = "and DataProviderId in (@DataProviderId)";
            string dataProviderStatment = @"select 
...
(
	select  min(day) min_day, max(day) max_day, count(day) Duration
	from adfalcon.data_provider_performance  
	where day between @past_day and @present_day and day < @today  @filter
		And EXISTS (SELECT * FROM business_partners
                WHERE business_partners.accountid = @accountid and business_partners.id =data_provider_performance.DataProviderId )
    --group by CampaignId 
) input 
inner join 
(
...
";
        ...
        public  List<KPIConfigDto> GetKPIConfigs()
            {

            IList<KPIConfig>   data=  _KPIConfigRepository.GetAll().ToList();

            return data.Select(M => MapperHelper.Map<KPIConfigDto>(M)).ToList();
        }
