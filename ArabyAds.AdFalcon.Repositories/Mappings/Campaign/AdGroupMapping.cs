...
{
    public class AdGroupMapping : ClassMap<ArabyAds.AdFalcon.Domain.Model.Campaign.AdGroup>
    {
        ...
        // Map(x => x.NameLower);
            ...
            HasMany(d => d.Ads).KeyColumn("AdGroupId").Cascade.All().BatchSize(500);
            ...
            HasMany(d => d.AdGroupBidModifiers).KeyColumn("AdGroupId").Cascade.All().Where("AdGroupId>0");
