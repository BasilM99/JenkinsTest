...
const CloneComponent = (props) =>{
    ...
    const submitForm = (data, e) =>{
        ...
        axios({
            method: 'get',
            url:props.cloneUrl +"&name="+data.Name,
            //data:Jdata,
            headers: {
            ...
            .then(success => {
                ...
                {
                    let message = props.cloneSuccessMessage.replace("{0}",props.name);
                    toggle();
    ...
    return (
    <React.Fragment>
        <button className="btn-outline-primary btn"  onClick={toggle}  title={props.title}><a  ><span className={"ri-file-copy-fill p-2"} /></a></button>
