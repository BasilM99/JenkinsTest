...
const AlertComponent = ({
  ...
  panelClass, children,CallBackToggle
}) => {
        ...
        >
          <CardBody className="panel__body">
            ...
            <div className="panel__btns">
              ...
              {collapse ?  <button className="panel__btn" type="button" onClick={toggleCollapse}><ChevronDownIcon /></button>: <button className="panel__btn" type="button" onClick={toggleCollapse}><ChevronUpIcon /></button>}
              {refresh ? <button className="panel__btn" type="button" onClick={onRefresh}><AutorenewIcon /></button>:''}
