    ...
    return (
      <div className="sidebar__content">
        ...
        <ul className="sidebar__block">
          ...
          <SidebarLink title="Todo Application" newLink icon="book" route="/todo" onClick={this.hideSidebar} />
          ...
          <SidebarCategory title="Tables" icon="list" isNew>
            ...
            <SidebarLink title="Data table" newLink route="/tables/data_table" onClick={this.hideSidebar} />
