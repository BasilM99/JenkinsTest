...
const Masterpage = ({ children }) => {
  ...
  <button onClick={handleChangeTheme}    type='button' class='btn header-item waves-effect' data-toggle='dropdown' aria-haspopup='true' aria-expanded='false'>
    <img class='' src='assets/images/flags/us.jpg' alt='Header Language' height='16'/>
    <h3> {currentTheme}</h3>
  </button>
  </div>
<div class='dropdown d-none d-sm-inline-block'>
  <button onClick={handleLanguageChange}    type='button' class='btn header-item waves-effect' data-toggle='dropdown' aria-haspopup='true' aria-expanded='false'>
    <img class='' src='assets/images/flags/us.jpg' alt='Header Language' height='16'/>
