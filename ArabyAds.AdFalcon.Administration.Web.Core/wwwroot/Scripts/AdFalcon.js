...
function resetReport() {
    ...
    //if (typeof($("#ReportGrid").data("kendoGrid") !='undefined' ))
    //{
    //TelerikgridInitilizeForMigration($("#ReportGrid"));


    //jQuery('#ReportGrid').tGrid({columns:[{"title":"Date Range","member":"DateRange","type":"String"},{"title":"Name","member":"Name","type":"String"},{"title":"Campaign Name","member":"SubName","type":"String"},{"title":"Impressions","member":"Impress","type":"Number"},{"title":"Clicks","member":"Clicks","type":"Number"},{"title":"CTR","member":"CtrText","type":"String"},{"title":"Avg.CPC","member":"AvgCPCText","type":"String"},{"title":"Spend","member":"SpendText","type":"String"}], total:0, currentPage:1, pageSizesInDropDown:["5","10","20","50"], pageOnScroll:false, ajax:{"selectUrl":"/ArabyAds.AdFalcon.Administration.Web/en/reports/CampaignReport?CampaignId=\u0026058a8f9c-e9a4-445a-a093-0f2ed7313f78=System.Web.Mvc.DictionaryValueProvider%601%5BSystem.Object%5D\u0026ReportGrid-size=10\u0026reportType=ad"}, onDataBinding:reportDataBinding, onDataBound:gridReportSuccess, onError:gridReportError, noRecordsTemplate:'No records to display.'});
    //jQuery('#Metrics').tGrid({columns:[{"title":"Name","member":"Name","type":"Object"},{"title":"","member":"","type":"Object"}], urlFormat:'/ArabyAds.AdFalcon.Administration.Web/en/reports/gcampaignchart?CampaignId=&058a8f9c-e9a4-445a-a093-0f2ed7313f78=System.Web.Mvc.DictionaryValueProvider%601%5BSystem.Object%5D&reportType=ad', pageSize:0, noRecordsTemplate:'No records to display.'});
...
function reportDataBindingData() {
        ...
        if (item.attr("type") == "rename") {
            ...
            if (basicurl.indexOf("?") != -1) {
                ...
                if (item.attr("type") == "dashboard") {
                    ...
                    if (basicurl.toLowerCase().indexOf("creative") > 0 || basicurl.toLowerCase().indexOf("addetails") > 0 || basicurl.toLowerCase().indexOf("copyad") > 0 ) {
...
function isdeletedBid(gridName, dataItem) {
    ...
    for (var i = 0; i < datads; i++) {
        if (typeof (datads[i]) != "undefined")
            if (dataItem.Appsite.ID == datads[i].Appsite.ID && dataItem.AccountId == datads[i].AccountId && dataItem.SubPublisherId == datads[i].SubPublisherId)
                return true;
    }
    return false;
...
function getBidCampaignBidConfigList() {
    ...
    for (var i = 0; i < data.length; i++)
        if (typeof (data[i]) != "undefined") {
            if (data[i].IsAdded)
            campaignBidConfigList.push(data[i].Bid);
        }
