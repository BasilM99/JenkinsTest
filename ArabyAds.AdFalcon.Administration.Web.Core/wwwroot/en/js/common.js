...
//        var url = $("#formApply").attr("action") + "?email=" + $("#email").val() + "&firstName=" + $("#firstName").val() + "&secondName=" + $("#secondName").val()
//         + "&phonenumber=" + $("#phonenumber").val() + "&company=" + $("#company").val() + "&address=" + $("#address").val() + "&message=" + $("#message").val();
...
function postContactUsRequest() {
    ...
    if (jQuery("#formApply").validate().form()) {
        var url = "../en/misc/ContactUsRequest";

        if (window.location.protocol == "https:") {
            url = "../en/misc/ContactUsHttpsRequest";
        }
